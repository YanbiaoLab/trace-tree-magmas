...
inductive Code : CM → CM → CM → Prop
  | law (x v0 v1 H0 H1 : CM)
      (s0 : Step x v1 H0)
      (s1 : Step v0 H0 H1) :
      Code (p (p (p H1 v0) v0) x) v0 x
inductive Step : CM → CM → CM → Prop
  | raw (a b : CM) : Step a b (p a b)
  | hit {a b o : CM} (h : Code a b o) : Step a b o
end
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 : CM, Step q_x q_v1 q_H0 ∧ Step q_v0 q_H0 q_H1 ∧ a = (p (p (p q_H1 q_v0) q_v0) q_x) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
...
theorem code_no_pair_left (v k : CM) :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change v = (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) at e0
      have e1 := congrArg (fun q => (R q)) ha
      change k = q_x at e1
      have e2 := congrArg (fun q => q) hb
      change v = q_v0 at e2
      have cyc : q_v0 = (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) := (let peq0 : v = (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) := e0; let peq2 : v = q_v0 := e2; let pst0 : (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) = v := Eq.symm (peq0); let pst1 : (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) = q_v0 := Eq.trans (pst0) (peq2); let pst2 : q_v0 = (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) := Eq.symm (pst1); pst2)
      have hlt : sz q_v0 < sz (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_v0 (p q_x q_v1)) (sz_lt_p_left (p q_v0 (p q_x q_v1)) q_v0)) (sz_lt_p_left (p (p q_v0 (p q_x q_v1)) q_v0) q_v0)
  ...
  | raw =>
    ...
    | raw =>
      ...
      | hit qs1h =>
        ...
        have e3 := congrArg (fun q => q) hb
        change v0 = q_v0 at e3
        have cyc : q_v0 = (p q_H1 q_v0) := (let peq0 : v0 = (p q_H1 q_v0) := e0; let peq3 : v0 = q_v0 := e3; let pst0 : (p q_H1 q_v0) = v0 := Eq.symm (peq0); let pst1 : (p q_H1 q_v0) = q_v0 := Eq.trans (pst0) (peq3); let pst2 : q_v0 = (p q_H1 q_v0) := Eq.symm (pst1); pst2)
    ...
    | hit qs0h =>
      ...
      | raw =>
        ...
        have e3 := congrArg (fun q => q) hb
        change v0 = q_v0 at e3
        have cyc : q_v0 = (p (p q_v0 q_H0) q_v0) := (let peq0 : v0 = (p (p q_v0 q_H0) q_v0) := e0; let peq3 : v0 = q_v0 := e3; let pst0 : (p (p q_v0 q_H0) q_v0) = v0 := Eq.symm (peq0); let pst1 : (p (p q_v0 q_H0) q_v0) = q_v0 := Eq.trans (pst0) (peq3); let pst2 : q_v0 = (p (p q_v0 q_H0) q_v0) := Eq.symm (pst1); pst2)
  ...
  | hit s1h =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        change H1 = (p (p (p q_v0 (p q_x q_v1)) q_v0) q_v0) at p0
        ...
        have badlt : sz v0 < sz H1 := by
          have structural : sz q_x < sz (p (p (p q_x (p q_x q_v1)) q_x) q_x) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_x (p q_x q_v1)) (sz_lt_p_left (p q_x (p q_x q_v1)) q_x)) (sz_lt_p_left (p (p q_x (p q_x q_v1)) q_x) q_x)
          have large_eq : sz v0 = sz q_x := congrArg sz (p1)
          have small_eq : sz H1 = sz (p (p (p q_x (p q_x q_v1)) q_x) q_x) := congrArg sz (Eq.trans (p0) (Eq.trans (congrArg (fun q => p q q_v0) (Eq.trans (congrArg (fun q => p q q_v0) (congrArg (fun q => p q (p q_x q_v1)) (Eq.trans (p2.symm) (p1)))) (congrArg (fun q => p (p q_x (p q_x q_v1)) q) (Eq.trans (p2.symm) (p1))))) (congrArg (fun q => p (p (p q_x (p q_x q_v1)) q_x) q) (Eq.trans (p2.symm) (p1)))))
      ...
      | hit qs1h =>
        ...
        have z3 := congrArg sz p3
        have badlt : sz v0 < sz H1 := by
          have structural : sz q_x < sz (p (p q_H1 q_x) q_x) := Nat.lt_trans (sz_lt_p_right q_H1 q_x) (sz_lt_p_left (p q_H1 q_x) q_x)
          have large_eq : sz v0 = sz q_x := congrArg sz (p1)
          have small_eq : sz H1 = sz (p (p q_H1 q_x) q_x) := congrArg sz (Eq.trans (p0) (Eq.trans (congrArg (fun q => p q q_v0) (congrArg (fun q => p q_H1 q) (Eq.trans (p2.symm) (p1)))) (congrArg (fun q => p (p q_H1 q_x) q) (Eq.trans (p2.symm) (p1)))))
          exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
        exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s1hB.2).elim
    | hit qs0h =>
      have qs1B := step_bound qs1
      ...
      | raw =>
        ...
        have z3 := congrArg sz p3
        have badlt : sz v0 < sz H1 := by
          have structural : sz q_x < sz (p (p (p q_x q_H0) q_x) q_x) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_x q_H0) (sz_lt_p_left (p q_x q_H0) q_x)) (sz_lt_p_left (p (p q_x q_H0) q_x) q_x)
          have large_eq : sz v0 = sz q_x := congrArg sz (p1)
          have small_eq : sz H1 = sz (p (p (p q_x q_H0) q_x) q_x) := congrArg sz (Eq.trans (p0) (Eq.trans (congrArg (fun q => p q q_v0) (Eq.trans (congrArg (fun q => p q q_v0) (congrArg (fun q => p q q_H0) (Eq.trans (p2.symm) (p1)))) (congrArg (fun q => p (p q_x q_H0) q) (Eq.trans (p2.symm) (p1))))) (congrArg (fun q => p (p (p q_x q_H0) q_x) q) (Eq.trans (p2.symm) (p1)))))
          exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
        exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s1hB.2).elim
      | hit qs1h =>
        have hcB := code_bounds hc
    ...
    | raw =>
      ...
      | raw =>
        ...
        have badlt : sz v0 < sz H1 := by
          ...
          have small_eq : sz H1 = sz (p (p q_v0 (p q_v0 q_v1)) q_v0) := congrArg sz (Eq.trans (p0) (congrArg (fun q => p q q_v0) (congrArg (fun q => p q_v0 q) (congrArg (fun q => p q q_v1) (Eq.trans (p2.symm) (p1))))))
          exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
        exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s1hB.2).elim
      | hit qs1h =>
        have hcB := code_bounds hc
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval (eval (eval (eval v0 (eval x v1)) v0) v0) x) v0) := by
  let H0 := eval x v1
  have e0a : x = x := by
    change x = x
    rfl
  ...
  change x = (eval (eval (eval (eval H1 v0) v0) x) v0)
  have rawEq : (eval (eval (eval (eval H1 v0) v0) x) v0) = (eval (p (p (p H1 v0) v0) x) v0) := by
    calc
      (eval (eval (eval (eval H1 v0) v0) x) v0) = (eval (eval (eval (p H1 v0) v0) x) v0) := congrArg (fun q => (eval (eval (eval q v0) x) v0)) (eval_raw (nr0 x v0 v1 H1 s1))
      _ = (eval (eval (p (p H1 v0) v0) x) v0) := congrArg (fun q => (eval (eval q x) v0)) (eval_raw (nr1 x v0 v1 H1 s1))
      _ = (eval (p (p (p H1 v0) v0) x) v0) := congrArg (fun q => (eval q v0)) (eval_raw (nr2 x v0 v1 H1 s1))
