...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 q_H2 q_H3 : CM, Step q_v1 q_x q_H0 ∧ Step q_v0 q_H0 q_H1 ∧ Step q_v0 q_H1 q_H2 ∧ Step q_x q_v0 q_H3 ∧ a = (p q_H2 (p q_H3 q_x)) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change v = (p q_v0 (p q_v0 (p q_v1 q_x))) at e0
        ...
        | hit qs3h =>
          ...
          change v = (p q_v0 (p q_v0 (p q_v1 q_x))) at p0
      ...
      | hit qs2h =>
        ...
        | hit qs3h =>
          ...
          change o = q_x at p3
          have z3 := congrArg sz p3
          have badlt : sz q_v0 < sz (p q_v0 (p q_v1 q_x)) := by
            have structural : sz (p q_H3 q_x) < sz (p (p q_H3 q_x) (p q_v1 q_x)) := sz_lt_p_left (p q_H3 q_x) (p q_v1 q_x)
            have large_eq : sz q_v0 = sz (p q_H3 q_x) := congrArg sz (Eq.trans (p2.symm) (p1))
            have small_eq : sz (p q_v0 (p q_v1 q_x)) = sz (p (p q_H3 q_x) (p q_v1 q_x)) := congrArg sz (congrArg (fun q => p q (p q_v1 q_x)) (Eq.trans (p2.symm) (p1)))
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
      ...
      | raw =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            change b = (p q_v0 (p q_v1 q_x)) at e1
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have cyc : q_x = (p (p q_H3 q_x) (p q_v1 q_x)) := (let peq0 : a = q_v0 := congrArg (fun q => (L (L q))) (ha); let peq1 : b = (p q_v0 (p q_v1 q_x)) := congrArg (fun q => (R (L q))) (ha); let peq2 : a = (p q_H3 q_x) := congrArg (fun q => (R q)) (ha); let peq4 : b = q_x := ho; let pst0 : q_v0 = a := Eq.symm (peq0); let pst1 : q_v0 = (p q_H3 q_x) := Eq.trans (pst0) (peq2); let pst2 : (p q_v0 (p q_v1 q_x)) = (p (p q_H3 q_x) (p q_v1 q_x)) := congrArg (fun q => p q (p q_v1 q_x)) (pst1); let pst3 : b = (p (p q_H3 q_x) (p q_v1 q_x)) := Eq.trans (peq1) (pst2); let pst4 : (p (p q_H3 q_x) (p q_v1 q_x)) = b := Eq.symm (pst3); let pst5 : (p (p q_H3 q_x) (p q_v1 q_x)) = q_x := Eq.trans (pst4) (peq4); let pst6 : q_x = (p (p q_H3 q_x) (p q_v1 q_x)) := Eq.symm (pst5); pst6)
            have hlt : sz q_x < sz (p (p q_H3 q_x) (p q_v1 q_x)) := Nat.lt_trans (sz_lt_p_right q_H3 q_x) (sz_lt_p_left (p q_H3 q_x) (p q_v1 q_x))
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have qs3B := step_bound qs3
          have qs3N := step_no_first qs3
          ...
          | raw =>
            ...
            have z3 := congrArg sz p3
            have badlt : sz q_v0 < sz (p q_v0 (p q_v1 q_x)) := by
              have structural : sz q_v0 < sz (p q_v0 (p q_v1 q_x)) := sz_lt_p_left q_v0 (p q_v1 q_x)
              have large_eq : sz q_v0 = sz q_v0 := congrArg sz (rfl)
              have small_eq : sz (p q_v0 (p q_v1 q_x)) = sz (p q_v0 (p q_v1 q_x)) := congrArg sz (rfl)
              exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
            exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) qs2hB.1).elim
          | hit qs3h =>
            have hcB := code_bounds hc
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval (eval v0 (eval v0 (eval v1 x))) (eval (eval x v0) x)) v0) := by
  let H0 := eval v1 x
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
  ...
  let H2 := eval v0 (eval v0 (eval v1 x))
  have e2a : v0 = v0 := by
    change v0 = v0
    rfl
  have e2b : (eval v0 (eval v1 x)) = H1 := by
    change H1 = H1
    rfl
  have s2 : Step v0 H1 H2 := by
    rw [← e2a, ← e2b]
    exact eval_step v0 (eval v0 (eval v1 x))
  let H3 := eval x v0
  have e3a : x = x := by
    change x = x
    rfl
