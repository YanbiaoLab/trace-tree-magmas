...
theorem nr0 (x v0 v1 H0 : CM)
  ...
  | raw =>
    ...
    | raw =>
      ...
      have cyc : q_v1 = (p (p (p q_v0 q_x) q_v0) q_v1) := (let peq0 : v0 = (p (p (p q_v0 q_x) q_v0) q_v1) := e0; let peq2 : v0 = q_v1 := e2; let pst0 : (p (p (p q_v0 q_x) q_v0) q_v1) = v0 := Eq.symm (peq0); let pst1 : (p (p (p q_v0 q_x) q_v0) q_v1) = q_v1 := Eq.trans (pst0) (peq2); let pst2 : q_v1 = (p (p (p q_v0 q_x) q_v0) q_v1) := Eq.symm (pst1); pst2)
  ...
  | hit s0h =>
    ...
    | raw =>
      ...
      have hx : sz q_v1 < sz (p (p (p (p q_v0 q_x) q_v0) q_v1) q_x) := by
        ...
        have ev : sz H0 = sz (p (p (p (p q_v0 q_x) q_v0) q_v1) q_x) := congrArg sz (p0)
    ...
    | hit qs0h =>
      ...
      have hx : sz q_v1 < sz (p (p (p q_H0 q_v0) q_v1) q_x) := by
        have q := hcB.1
        have eu : sz v0 = sz q_v1 := congrArg sz (p1)
        have ev : sz H0 = sz (p (p (p q_H0 q_v0) q_v1) q_x) := congrArg sz (p0)
        have q1 : sz q_v1 < sz H0 := lt_of_eq_of_lt eu.symm q
        exact lt_of_lt_of_eq q1 ev
  ...
  | raw =>
    ...
    | hit qs0h =>
      ...
      have badlt : sz q_v0 < sz q_x := by
        ...
        have small_eq : sz q_x = sz (p q_H0 q_v0) := congrArg sz (Eq.trans (p2.symm) (p0))
  ...
  | hit s0h =>
    ...
    | raw =>
      ...
      have badlt : sz v0 < sz H0 := by
        have structural : sz q_x < sz (p (p (p q_v0 q_x) q_v0) q_v1) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_right q_v0 q_x) (sz_lt_p_left (p q_v0 q_x) q_v0)) (sz_lt_p_left (p (p q_v0 q_x) q_v0) q_v1)
...
theorem nr2 (x v0 v1 H0 : CM)
  ...
  cases s0 with
  | raw =>
    have he : q_H0 = q_v0 := (let peq0 : v0 = q_H0 := congrArg (fun q => (L (L (L q)))) (ha); let peq1 : x = q_v0 := congrArg (fun q => (R (L (L q)))) (ha); let peq2 : v0 = q_v1 := congrArg (fun q => (R (L q))) (ha); let peq4 : x = q_v1 := hb; let pst0 : q_H0 = v0 := Eq.symm (peq0); let pst1 : q_H0 = q_v1 := Eq.trans (pst0) (peq2); let pst2 : q_v0 = x := Eq.symm (peq1); let pst3 : q_v0 = q_v1 := Eq.trans (pst2) (peq4); let pst4 : q_v1 = q_v0 := Eq.symm (pst3); let pst5 : q_H0 = q_v0 := Eq.trans (pst1) (pst4); pst5)
