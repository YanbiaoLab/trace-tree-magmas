...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 q_H2 q_H3 : CM, Step q_v0 q_v1 q_H0 ∧ Step q_v0 q_H0 q_H1 ∧ Step q_v0 q_H1 q_H2 ∧ Step q_x q_v0 q_H3 ∧ a = (p q_H2 (p q_H3 q_x)) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
...
theorem code_bounds_core (q : CodeArg) :
  ...
  rcases code_shape h with ⟨x, v0, v1, H0, H1, H2, H3, s0, s1, s2, s3, ha, hb, ho⟩
  subst a
  subst b
  subst x
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change v = (p q_v0 (p q_v0 (p q_v0 q_v1))) at e0
        ...
        | hit qs3h =>
          ...
          change v = (p q_v0 (p q_v0 (p q_v0 q_v1))) at p0
      ...
      | hit qs2h =>
        ...
        | hit qs3h =>
          ...
          change o = q_x at p3
          have z3 := congrArg sz p3
          have badlt : sz q_v0 < sz (p q_v0 (p q_v0 q_v1)) := by
            have structural : sz (p q_H3 q_x) < sz (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := sz_lt_p_left (p q_H3 q_x) (p (p q_H3 q_x) q_v1)
            have large_eq : sz q_v0 = sz (p q_H3 q_x) := congrArg sz (Eq.trans (p2.symm) (p1))
            have small_eq : sz (p q_v0 (p q_v0 q_v1)) = sz (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := congrArg sz (Eq.trans (congrArg (fun q => p q (p q_v0 q_v1)) (Eq.trans (p2.symm) (p1))) (congrArg (fun q => p (p q_H3 q_x) q) (congrArg (fun q => p q q_v1) (Eq.trans (p2.symm) (p1)))))
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
      ...
      | raw =>
        ...
        | hit qs3h =>
          ...
          have badlt : sz q_v0 < sz (p q_v0 q_v1) := by
            have structural : sz (p q_H3 q_x) < sz (p (p q_H3 q_x) q_v1) := sz_lt_p_left (p q_H3 q_x) q_v1
            have large_eq : sz q_v0 = sz (p q_H3 q_x) := congrArg sz (Eq.trans (p2.symm) (p1))
            have small_eq : sz (p q_v0 q_v1) = sz (p (p q_H3 q_x) q_v1) := congrArg sz (congrArg (fun q => p q q_v1) (Eq.trans (p2.symm) (p1)))
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
  ...
  | hit qs0h =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          have e0 := congrArg (fun q => (L q)) ha
          change v = (p q_v0 (p q_v0 q_H0)) at e0
          have e1 := congrArg (fun q => (R q)) ha
          change k = (p (p q_x q_v0) q_x) at e1
          have e2 := congrArg (fun q => q) hb
          change k = q_v0 at e2
        ...
        | hit qs3h =>
          ...
          have qs3B := qs3B
          have p0 := congrArg (fun q => (L q)) (ha)
          change v = (p q_v0 (p q_v0 q_H0)) at p0
          have z0 := congrArg sz p0
          have p1 := congrArg (fun q => (R q)) (ha)
          change k = (p q_H3 q_x) at p1
          have z1 := congrArg sz p1
      ...
      | hit qs2h =>
        ...
        | hit qs3h =>
          ...
          change o = q_x at p3
          have z3 := congrArg sz p3
          have badlt : sz q_v0 < sz (p q_v0 q_H0) := by
            have structural : sz (p q_H3 q_x) < sz (p (p q_H3 q_x) q_H0) := sz_lt_p_left (p q_H3 q_x) q_H0
            have large_eq : sz q_v0 = sz (p q_H3 q_x) := congrArg sz (Eq.trans (p2.symm) (p1))
            have small_eq : sz (p q_v0 q_H0) = sz (p (p q_H3 q_x) q_H0) := congrArg sz (congrArg (fun q => p q q_H0) (Eq.trans (p2.symm) (p1)))
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
          exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) qs2hB.1).elim
    | hit qs1h =>
      have qs2B := step_bound qs2
      ...
      | raw =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            change b = (p q_v0 (p q_v0 q_v1)) at e1
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have cyc : q_x = (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := (let peq0 : a = q_v0 := congrArg (fun q => (L (L q))) (ha); let peq1 : b = (p q_v0 (p q_v0 q_v1)) := congrArg (fun q => (R (L q))) (ha); let peq2 : a = (p q_H3 q_x) := congrArg (fun q => (R q)) (ha); let peq4 : b = q_x := ho; let pst0 : q_v0 = a := Eq.symm (peq0); let pst1 : q_v0 = (p q_H3 q_x) := Eq.trans (pst0) (peq2); let pst2 : (p q_v0 (p q_v0 q_v1)) = (p (p q_H3 q_x) (p q_v0 q_v1)) := congrArg (fun q => p q (p q_v0 q_v1)) (pst1); let pst3 : (p q_v0 q_v1) = (p (p q_H3 q_x) q_v1) := congrArg (fun q => p q q_v1) (pst1); let pst4 : (p (p q_H3 q_x) (p q_v0 q_v1)) = (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := congrArg (fun q => p (p q_H3 q_x) q) (pst3); let pst5 : (p q_v0 (p q_v0 q_v1)) = (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := Eq.trans (pst2) (pst4); let pst6 : b = (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := Eq.trans (peq1) (pst5); let pst7 : (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) = b := Eq.symm (pst6); let pst8 : (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) = q_x := Eq.trans (pst7) (peq4); let pst9 : q_x = (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := Eq.symm (pst8); pst9)
            have hlt : sz q_x < sz (p (p q_H3 q_x) (p (p q_H3 q_x) q_v1)) := Nat.lt_trans (sz_lt_p_right q_H3 q_x) (sz_lt_p_left (p q_H3 q_x) (p (p q_H3 q_x) q_v1))
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have qs3B := step_bound qs3
          have qs3N := step_no_first qs3
          ...
          | raw =>
            ...
            have z3 := congrArg sz p3
            have badlt : sz q_v0 < sz (p q_v0 (p q_v0 q_v1)) := by
              have structural : sz q_v0 < sz (p q_v0 (p q_v0 q_v1)) := sz_lt_p_left q_v0 (p q_v0 q_v1)
              have large_eq : sz q_v0 = sz q_v0 := congrArg sz (rfl)
              have small_eq : sz (p q_v0 (p q_v0 q_v1)) = sz (p q_v0 (p q_v0 q_v1)) := congrArg sz (rfl)
              exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
            exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) qs2hB.1).elim
          | hit qs3h =>
            have hcB := code_bounds hc
      ...
      | hit qs1h =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have ena : q_x = q_H1 := (let peq1 : b = q_H1 := congrArg (fun q => (R (L q))) (ha); let peq4 : b = q_x := ho; let pst0 : q_H1 = b := Eq.symm (peq1); let pst1 : q_H1 = q_x := Eq.trans (pst0) (peq4); let pst2 : q_x = q_H1 := Eq.symm (pst1); pst2)
            have enb : q_v0 = q_v0 := (let peq0 : a = q_v0 := congrArg (fun q => (L (L q))) (ha); let peq2 : a = (p q_H3 q_x) := congrArg (fun q => (R q)) (ha); let pst0 : q_v0 = a := Eq.symm (peq0); let pst1 : q_v0 = (p q_H3 q_x) := Eq.trans (pst0) (peq2); let pst2 : (p q_H3 q_x) = q_v0 := Eq.symm (pst1); let pst3 : q_v0 = q_v0 := Eq.trans (pst1) (pst2); pst3)
            apply qs1N
            refine ⟨q_H3, ?_⟩
            simpa only [ena, enb] using qs3h
        | hit qs2h =>
          have qs3B := step_bound qs3
          have qs3N := step_no_first qs3
          cases qs3 with
      ...
      | raw =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have cyc : q_x = (p (p q_H3 q_x) q_H0) := (let peq0 : a = q_v0 := congrArg (fun q => (L (L q))) (ha); let peq1 : b = (p q_v0 q_H0) := congrArg (fun q => (R (L q))) (ha); let peq2 : a = (p q_H3 q_x) := congrArg (fun q => (R q)) (ha); let peq4 : b = q_x := ho; let pst0 : q_v0 = a := Eq.symm (peq0); let pst1 : q_v0 = (p q_H3 q_x) := Eq.trans (pst0) (peq2); let pst2 : (p q_v0 q_H0) = (p (p q_H3 q_x) q_H0) := congrArg (fun q => p q q_H0) (pst1); let pst3 : b = (p (p q_H3 q_x) q_H0) := Eq.trans (peq1) (pst2); let pst4 : (p (p q_H3 q_x) q_H0) = b := Eq.symm (pst3); let pst5 : (p (p q_H3 q_x) q_H0) = q_x := Eq.trans (pst4) (peq4); let pst6 : q_x = (p (p q_H3 q_x) q_H0) := Eq.symm (pst5); pst6)
            have hlt : sz q_x < sz (p (p q_H3 q_x) q_H0) := Nat.lt_trans (sz_lt_p_right q_H3 q_x) (sz_lt_p_left (p q_H3 q_x) q_H0)
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have qs3B := step_bound qs3
          have qs3N := step_no_first qs3
          ...
          | raw =>
            ...
            have z3 := congrArg sz p3
            have badlt : sz q_v0 < sz (p q_v0 q_H0) := by
              have structural : sz q_v0 < sz (p q_v0 q_H0) := sz_lt_p_left q_v0 q_H0
              have large_eq : sz q_v0 = sz q_v0 := congrArg sz (rfl)
              have small_eq : sz (p q_v0 q_H0) = sz (p q_v0 q_H0) := congrArg sz (rfl)
              exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
            exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) qs2hB.1).elim
          | hit qs3h =>
            have hcB := code_bounds hc
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval (eval v0 (eval v0 (eval v0 v1))) (eval (eval x v0) x)) v0) := by
  let H0 := eval v0 v1
  have e0a : v0 = v0 := by
    change v0 = v0
    rfl
  ...
  have rawEq : (eval (eval H2 (eval H3 x)) v0) = (eval (p H2 (p H3 x)) v0) := by
    calc
      (eval (eval H2 (eval H3 x)) v0) = (eval (eval H2 (p H3 x)) v0) := congrArg (fun q => (eval (eval H2 q) v0)) (eval_raw (nr0 x v0 v1 H3 s3))
      _ = (eval (p H2 (p H3 x)) v0) := congrArg (fun q => (eval q v0)) (eval_raw (nr1 x v0 v1 H2 H3 s2 s3))
