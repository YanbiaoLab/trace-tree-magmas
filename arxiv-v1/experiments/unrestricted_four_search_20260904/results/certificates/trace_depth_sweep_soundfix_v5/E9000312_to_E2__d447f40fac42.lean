...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_v2 q_H0 q_H1 q_H2 : CM, Step q_v2 q_v0 q_H0 ∧ Step q_v1 q_H0 q_H1 ∧ Step q_v0 q_H1 q_H2 ∧ a = (p (p (p q_H2 q_v0) q_v0) q_x) ∧ b = (p q_v0 q_v0) ∧ o = q_x := by
  exact match h with
  ...
  | raw =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        change v = (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) at e0
        have e1 := congrArg (fun q => (R q)) ha
        change k = q_x at e1
        have e2 := congrArg (fun q => q) hb
        change v = (p q_v0 q_v0) at e2
        have cyc : q_v0 = (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) := (let peq0 : v = (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) := e0; let peq2 : v = (p q_v0 q_v0) := e2; let pst0 : (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) = v := Eq.symm (peq0); let pst1 : (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) = (p q_v0 q_v0) := Eq.trans (pst0) (peq2); let pst2 : (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) = q_v0 := congrArg (fun q => L q) (pst1); let pst3 : q_v0 = (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) := Eq.symm (pst2); pst3)
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change H2 = (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) at p0
      ...
      | raw =>
        ...
        | raw =>
          ...
          have badlt : sz v0 < sz H2 := by
            have structural : sz q_v0 < sz (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) := Nat.lt_trans (sz_lt_p_left q_v0 (p q_v1 (p q_v2 q_v0))) (sz_lt_p_left (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0)
            have large_eq : sz v0 = sz q_v0 := congrArg sz (p1)
            have small_eq : sz H2 = sz (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) := congrArg sz (p0)
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
  ...
  | raw =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        change v0 = (p (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) q_x) at e0
        have e1 := congrArg (fun q => q) hb
        change v0 = (p q_v0 q_v0) at e1
        have cyc : q_v0 = (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) := (let peq0 : v0 = (p (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) q_x) := e0; let peq1 : v0 = (p q_v0 q_v0) := e1; let pst0 : (p (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) q_x) = v0 := Eq.symm (peq0); let pst1 : (p (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) q_x) = (p q_v0 q_v0) := Eq.trans (pst0) (peq1); let pst2 : (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) = q_v0 := congrArg (fun q => L q) (pst1); let pst3 : q_v0 = (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) := Eq.symm (pst2); pst3)
        have hlt : sz q_v0 < sz (p (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_v0 (p q_v1 (p q_v2 q_v0))) (sz_lt_p_left (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0)) (sz_lt_p_left (p (p q_v0 (p q_v1 (p q_v2 q_v0))) q_v0) q_v0)
        exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
      | hit qs2h =>
        have e0 := congrArg (fun q => q) ha
...
theorem source_holds (x v0 v1 v2 : CM) :
    x = (eval (eval (eval (eval (eval v0 (eval v1 (eval v2 v0))) v0) v0) x) (eval v0 v0)) := by
  let H0 := eval v2 v0
  have e0a : v2 = v2 := by
    change v2 = v2
    rfl
