...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 : CM, Step q_v1 q_x q_H0 ∧ Step q_v0 q_H0 q_H1 ∧ a = (p q_v0 (p q_x q_x)) ∧ b = (p q_H1 q_v0) ∧ o = q_x := by
  exact match h with
...
theorem code_no_pair_left (v k : CM) :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change v = (p (p q_v0 (p q_v1 q_x)) q_v0) at e2
      have cyc : q_v0 = (p (p q_v0 (p q_v1 q_x)) q_v0) := (let peq0 : v = q_v0 := e0; let peq2 : v = (p (p q_v0 (p q_v1 q_x)) q_v0) := e2; let pst0 : q_v0 = v := Eq.symm (peq0); let pst1 : q_v0 = (p (p q_v0 (p q_v1 q_x)) q_v0) := Eq.trans (pst0) (peq2); pst1)
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval v0 (eval x x)) (eval (eval v0 (eval v1 x)) v0)) := by
  let H0 := eval v1 x
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
  ...
  have rawEq : (eval (eval v0 (eval x x)) (eval H1 v0)) = (eval (p v0 (p x x)) (p H1 v0)) := by
    calc
      (eval (eval v0 (eval x x)) (eval H1 v0)) = (eval (eval v0 (p x x)) (eval H1 v0)) := congrArg (fun q => (eval (eval v0 q) (eval H1 v0))) (eval_raw (nr0 x v0 v1))
      _ = (eval (p v0 (p x x)) (eval H1 v0)) := congrArg (fun q => (eval q (eval H1 v0))) (eval_raw (nr1 x v0 v1))
      _ = (eval (p v0 (p x x)) (p H1 v0)) := congrArg (fun q => (eval (p v0 (p x x)) q)) (eval_raw (nr2 x v0 v1 H1 s1))
