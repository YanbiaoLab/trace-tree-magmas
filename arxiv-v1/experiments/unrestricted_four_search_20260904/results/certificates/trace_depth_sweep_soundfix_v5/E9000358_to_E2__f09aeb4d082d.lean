...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 : CM, Step q_v1 q_v0 q_H0 ∧ Step q_v0 q_H0 q_H1 ∧ a = (p (p (p q_H1 q_v0) q_v0) (p q_x q_x)) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
...
theorem code_no_pair_left (v k : CM) :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change v = q_v0 at e2
      have cyc : q_v0 = (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) := (let peq0 : v = (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) := e0; let peq2 : v = q_v0 := e2; let pst0 : (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) = v := Eq.symm (peq0); let pst1 : (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) = q_v0 := Eq.trans (pst0) (peq2); let pst2 : q_v0 = (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) := Eq.symm (pst1); pst2)
  ...
  | raw =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        have cyc : q_v0 = (p q_v0 (p q_v1 q_v0)) := (let peq0 : v0 = (p (p q_v0 (p q_v1 q_v0)) q_v0) := e0; let peq2 : v0 = (p q_x q_x) := e2; let pst0 : (p (p q_v0 (p q_v1 q_v0)) q_v0) = v0 := Eq.symm (peq0); let pst1 : (p (p q_v0 (p q_v1 q_v0)) q_v0) = (p q_x q_x) := Eq.trans (pst0) (peq2); let pst2 : q_v0 = q_x := congrArg (fun q => R q) (pst1); let pst3 : (p q_v0 (p q_v1 q_v0)) = q_x := congrArg (fun q => L q) (pst1); let pst4 : q_x = (p q_v0 (p q_v1 q_v0)) := Eq.symm (pst3); let pst5 : q_v0 = (p q_v0 (p q_v1 q_v0)) := Eq.trans (pst2) (pst4); pst5)
    ...
    | raw =>
      ...
      | raw =>
        ...
        have badlt : sz v0 < sz H1 := by
          have structural : sz (p q_x q_x) < sz (p (p (p (p q_x q_x) (p q_v1 (p q_x q_x))) (p q_x q_x)) (p q_x q_x)) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_left (p q_x q_x) (p q_v1 (p q_x q_x))) (sz_lt_p_left (p (p q_x q_x) (p q_v1 (p q_x q_x))) (p q_x q_x))) (sz_lt_p_left (p (p (p q_x q_x) (p q_v1 (p q_x q_x))) (p q_x q_x)) (p q_x q_x))
          have large_eq : sz v0 = sz (p q_x q_x) := congrArg sz (p1)
          have small_eq : sz H1 = sz (p (p (p (p q_x q_x) (p q_v1 (p q_x q_x))) (p q_x q_x)) (p q_x q_x)) := congrArg sz (Eq.trans (p0) (Eq.trans (congrArg (fun q => p q q_v0) (Eq.trans (congrArg (fun q => p q q_v0) (Eq.trans (congrArg (fun q => p q (p q_v1 q_v0)) (Eq.trans (p2.symm) (p1))) (congrArg (fun q => p (p q_x q_x) q) (congrArg (fun q => p q_v1 q) (Eq.trans (p2.symm) (p1)))))) (congrArg (fun q => p (p (p q_x q_x) (p q_v1 (p q_x q_x))) q) (Eq.trans (p2.symm) (p1))))) (congrArg (fun q => p (p (p (p q_x q_x) (p q_v1 (p q_x q_x))) (p q_x q_x)) q) (Eq.trans (p2.symm) (p1)))))
 ...
 :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change x = (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) at e0
      have e1 := congrArg (fun q => q) hb
      change x = q_v0 at e1
      have cyc : q_v0 = (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) := (let peq0 : x = (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) := e0; let peq1 : x = q_v0 := e1; let pst0 : (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) = x := Eq.symm (peq0); let pst1 : (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) := Eq.symm (pst1); pst2)
      have hlt : sz q_v0 < sz (p (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x)) := Nat.lt_trans (Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_v0 (p q_v1 q_v0)) (sz_lt_p_left (p q_v0 (p q_v1 q_v0)) q_v0)) (sz_lt_p_left (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0)) (sz_lt_p_left (p (p (p q_v0 (p q_v1 q_v0)) q_v0) q_v0) (p q_x q_x))
      exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
    | hit qs1h =>
      have e0 := congrArg (fun q => q) ha
  ...
  | hit s1h =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        have badlt : sz v0 < sz H1 := by
          have structural : sz (p x x) < sz (p (p (p x x) (p q_v1 (p x x))) (p x x)) := Nat.lt_trans (sz_lt_p_left (p x x) (p q_v1 (p x x))) (sz_lt_p_left (p (p x x) (p q_v1 (p x x))) (p x x))
          have large_eq : sz v0 = sz (p x x) := congrArg sz (Eq.trans (p1) (p3.symm))
          have small_eq : sz H1 = sz (p (p (p x x) (p q_v1 (p x x))) (p x x)) := congrArg sz (Eq.trans (p0) (Eq.trans (congrArg (fun q => p q q_v0) (Eq.trans (congrArg (fun q => p q (p q_v1 q_v0)) (p3.symm)) (congrArg (fun q => p (p x x) q) (congrArg (fun q => p q_v1 q) (p3.symm))))) (congrArg (fun q => p (p (p x x) (p q_v1 (p x x))) q) (p3.symm))))
          exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
        exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s1hB.2).elim
      | hit qs1h =>
        have hcB := code_bounds hc
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval (eval (eval (eval v0 (eval v1 v0)) v0) v0) (eval x x)) v0) := by
  let H0 := eval v1 v0
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
