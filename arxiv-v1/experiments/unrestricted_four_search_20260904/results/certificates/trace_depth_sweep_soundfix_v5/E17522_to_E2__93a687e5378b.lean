...
inductive Code : CM → CM → CM → Prop
  | law (x v0 v1 H0 : CM)
      (s0 : Step v0 v1 H0) :
      Code H0 (p x (p v1 (p v1 v1))) x
inductive Step : CM → CM → CM → Prop
  | raw (a b : CM) : Step a b (p a b)
  | hit {a b o : CM} (h : Code a b o) : Step a b o
end
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 : CM, Step q_v0 q_v1 q_H0 ∧ a = q_H0 ∧ b = (p q_x (p q_v1 (p q_v1 q_v1))) ∧ o = q_x := by
  exact match h with
...
theorem nr0 (x v0 v1 : CM)
 :
  ...
  | raw =>
    ...
    have cyc : q_v1 = (p q_v1 (p q_v1 q_v1)) := (let peq0 : v1 = (p q_v0 q_v1) := e0; let peq1 : v1 = (p q_x (p q_v1 (p q_v1 q_v1))) := e1; let pst0 : (p q_v0 q_v1) = v1 := Eq.symm (peq0); let pst1 : (p q_v0 q_v1) = (p q_x (p q_v1 (p q_v1 q_v1))) := Eq.trans (pst0) (peq1); let pst2 : q_v1 = (p q_v1 (p q_v1 q_v1)) := congrArg (fun q => R q) (pst1); pst2)
...
theorem nr1 (x v0 v1 : CM)
 :
  ...
  | raw =>
    ...
    have cyc : q_v1 = (p q_v1 q_v1) := (let peq0 : v1 = (p q_v0 q_v1) := e0; let peq2 : v1 = (p q_v1 (p q_v1 q_v1)) := e2; let pst0 : (p q_v0 q_v1) = v1 := Eq.symm (peq0); let pst1 : (p q_v0 q_v1) = (p q_v1 (p q_v1 q_v1)) := Eq.trans (pst0) (peq2); let pst2 : q_v1 = (p q_v1 q_v1) := congrArg (fun q => R q) (pst1); pst2)
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval v0 v1) (eval x (eval v1 (eval v1 v1)))) := by
  let H0 := eval v0 v1
  have e0a : v0 = v0 := by
    change v0 = v0
    rfl
  ...
  change x = (eval H0 (eval x (eval v1 (eval v1 v1))))
  have rawEq : (eval H0 (eval x (eval v1 (eval v1 v1)))) = (eval H0 (p x (p v1 (p v1 v1)))) := by
    calc
      (eval H0 (eval x (eval v1 (eval v1 v1)))) = (eval H0 (eval x (eval v1 (p v1 v1)))) := congrArg (fun q => (eval H0 (eval x (eval v1 q)))) (eval_raw (nr0 x v0 v1))
      _ = (eval H0 (eval x (p v1 (p v1 v1)))) := congrArg (fun q => (eval H0 (eval x q))) (eval_raw (nr1 x v0 v1))
      _ = (eval H0 (p x (p v1 (p v1 v1)))) := congrArg (fun q => (eval H0 q)) (eval_raw (nr2 x v0 v1))
