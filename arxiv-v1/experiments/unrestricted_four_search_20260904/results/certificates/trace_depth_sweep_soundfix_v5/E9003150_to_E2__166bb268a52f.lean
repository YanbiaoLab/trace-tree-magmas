...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_v2 q_H0 q_H1 q_H2 : CM, Step q_v1 q_v2 q_H0 ∧ Step q_v0 (p q_H0 q_v1) q_H1 ∧ Step q_x q_v0 q_H2 ∧ a = (p q_H1 (p q_H2 q_x)) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
  ...
  | raw =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        change v = (p q_v0 (p (p q_v1 q_v2) q_v1)) at e0
      ...
      | hit qs2h =>
        ...
        change v = (p q_v0 (p (p q_v1 q_v2) q_v1)) at p0
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change b = (p (p q_v1 q_v2) q_v1) at e1
          ...
          exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have epa : (p (p a b) a) = (p (p (p q_H2 (p (p q_v1 q_v2) q_v1)) (p (p q_v1 q_v2) q_v1)) (p q_H2 (p (p q_v1 q_v2) q_v1))) := Eq.trans (congrArg (fun q => p q a) (Eq.trans (congrArg (fun q => p q b) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H2 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))))) (congrArg (fun q => p (p q_H2 (p (p q_v1 q_v2) q_v1)) q) (congrArg (fun q => (R (L q))) (ha))))) (congrArg (fun q => p (p (p q_H2 (p (p q_v1 q_v2) q_v1)) (p (p q_v1 q_v2) q_v1)) q) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H2 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho)))))))
          have epb : k = (p q_H2 (p (p q_v1 q_v2) q_v1)) := Eq.trans (Eq.trans (hb) (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha)))) (congrArg (fun q => p q_H2 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))
          apply code_no_pair_right (p (p q_H2 (p (p q_v1 q_v2) q_v1)) (p (p q_v1 q_v2) q_v1)) (p q_H2 (p (p q_v1 q_v2) q_v1))
...
theorem source_holds (x v0 v1 v2 : CM) :
    x = (eval (eval (eval v0 (eval (eval v1 v2) v1)) (eval (eval x v0) x)) v0) := by
  let H0 := eval v1 v2
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
