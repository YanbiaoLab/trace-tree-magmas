...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_v2 q_H0 q_H1 q_H2 : CM, Step q_v1 q_v2 q_H0 ∧ Step q_x q_H0 q_H1 ∧ Step q_H1 q_v0 q_H2 ∧ a = q_v0 ∧ b = (p q_x (p q_v0 (p q_v0 q_H2))) ∧ o = q_x := by
  exact match h with
  ...
  | raw =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        change v = (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) at e1
        have cyc : v = (p q_x (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))))) := (let peq0 : (p v k) = q_v0 := e0; let peq1 : v = (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) := e1; let pst0 : q_v0 = (p v k) := Eq.symm (peq0); let pst1 : (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) = (p (p v k) (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) := congrArg (fun q => p q (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) (pst0); let pst2 : (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) = (p (p v k) (p (p q_x (p q_v1 q_v2)) q_v0)) := congrArg (fun q => p q (p (p q_x (p q_v1 q_v2)) q_v0)) (pst0); let pst3 : (p (p q_x (p q_v1 q_v2)) q_v0) = (p (p q_x (p q_v1 q_v2)) (p v k)) := congrArg (fun q => p (p q_x (p q_v1 q_v2)) q) (pst0); let pst4 : (p (p v k) (p (p q_x (p q_v1 q_v2)) q_v0)) = (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))) := congrArg (fun q => p (p v k) q) (pst3); let pst5 : (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) = (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))) := Eq.trans (pst2) (pst4); let pst6 : (p (p v k) (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) = (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k)))) := congrArg (fun q => p (p v k) q) (pst5); let pst7 : (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) = (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k)))) := Eq.trans (pst1) (pst6); let pst8 : (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) = (p q_x (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))))) := congrArg (fun q => p q_x q) (pst7); let pst9 : v = (p q_x (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))))) := Eq.trans (peq1) (pst8); pst9)
        have hlt : sz v < sz (p q_x (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))))) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_left v k) (sz_lt_p_left (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k))))) (sz_lt_p_right q_x (p (p v k) (p (p v k) (p (p q_x (p q_v1 q_v2)) (p v k)))))
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change v0 = (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) at e2
          have cyc : q_v0 = (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) := (let peq0 : v0 = q_v0 := e0; let peq2 : v0 = (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) := e2; let pst0 : q_v0 = v0 := Eq.symm (peq0); let pst1 : q_v0 = (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) := Eq.trans (pst0) (peq2); pst1)
          have hlt : sz q_v0 < sz (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) := sz_lt_p_left q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))
          exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have e0 := congrArg (fun q => q) ha
          change v0 = q_v0 at e0
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          have p1 := hb
          change H2 = (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) at p1
          have z1 := congrArg sz p1
          have p2 := ho
          change o = q_x at p2
          have z2 := congrArg sz p2
          have hx : sz q_v0 < sz (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) := by
            have q := hcB.1
            have eu : sz v0 = sz q_v0 := congrArg sz (p0)
            have ev : sz H2 = sz (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) := congrArg sz (p1)
            have q1 : sz q_v0 < sz H2 := lt_of_eq_of_lt eu.symm q
            exact lt_of_lt_of_eq q1 ev
          have hy : sz (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) < sz q_v0 := by
            have q := s2hB.2
            have ev : sz H2 = sz (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) := congrArg sz (p1)
            have eu : sz v0 = sz q_v0 := congrArg sz (p0)
            have q1 : sz (p q_x (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)))) < sz v0 := lt_of_eq_of_lt ev.symm q
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change v0 = (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) at e3
          have cyc : q_x = (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := (let peq0 : v0 = q_v0 := e0; let peq1 : v0 = q_x := e1; let peq3 : v0 = (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) := e3; let pst0 : q_v0 = v0 := Eq.symm (peq0); let pst1 : q_v0 = q_x := Eq.trans (pst0) (peq1); let pst2 : v0 = q_x := Eq.trans (peq0) (pst1); let pst3 : q_x = v0 := Eq.symm (pst2); let pst4 : q_x = (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) := Eq.trans (pst3) (peq3); let pst5 : (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) = (p q_x (p (p q_x (p q_v1 q_v2)) q_v0)) := congrArg (fun q => p q (p (p q_x (p q_v1 q_v2)) q_v0)) (pst1); let pst6 : (p (p q_x (p q_v1 q_v2)) q_v0) = (p (p q_x (p q_v1 q_v2)) q_x) := congrArg (fun q => p (p q_x (p q_v1 q_v2)) q) (pst1); let pst7 : (p q_x (p (p q_x (p q_v1 q_v2)) q_v0)) = (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := congrArg (fun q => p q_x q) (pst6); let pst8 : (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) = (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := Eq.trans (pst5) (pst7); let pst9 : q_x = (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := Eq.trans (pst4) (pst8); pst9)
          have hlt : sz q_x < sz (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := sz_lt_p_left q_x (p (p q_x (p q_v1 q_v2)) q_x)
          exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have e0 := congrArg (fun q => q) ha
          change v0 = q_v0 at e0
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change H2 = (p q_v0 (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0))) at p2
          have z2 := congrArg sz p2
          have p3 := ho
          change o = q_x at p3
          have z3 := congrArg sz p3
          have badlt : sz v0 < sz H2 := by
            have structural : sz q_v0 < sz (p q_v0 (p q_v0 (p (p q_v0 (p q_v1 q_v2)) q_v0))) := sz_lt_p_left q_v0 (p q_v0 (p (p q_v0 (p q_v1 q_v2)) q_v0))
            have large_eq : sz v0 = sz q_v0 := congrArg sz (p0)
            have small_eq : sz H2 = sz (p q_v0 (p q_v0 (p (p q_v0 (p q_v1 q_v2)) q_v0))) := congrArg sz (Eq.trans (p2) (congrArg (fun q => p q_v0 q) (congrArg (fun q => p q_v0 q) (congrArg (fun q => p q q_v0) (congrArg (fun q => p q (p q_v1 q_v2)) (Eq.trans (p1.symm) (p0)))))))
        ...
        | hit qs2h =>
          have epa : (p q_x (p q_v1 q_v2)) = (p q_x (p q_v1 q_v2)) := rfl
          have epb : q_v0 = q_x := Eq.trans (Eq.symm (ha)) (congrArg (fun q => (L q)) (hb))
          apply code_no_pair_left q_x (p q_v1 q_v2)
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change H2 = (p q_v0 (p (p q_x (p q_v1 q_v2)) q_v0)) at p3
          have z3 := congrArg sz p3
          have p4 := ho
          change o = q_x at p4
          have z4 := congrArg sz p4
          have badlt : sz v0 < sz H2 := by
            have structural : sz q_x < sz (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := sz_lt_p_left q_x (p (p q_x (p q_v1 q_v2)) q_x)
            have large_eq : sz v0 = sz q_x := congrArg sz (p1)
            have small_eq : sz H2 = sz (p q_x (p (p q_x (p q_v1 q_v2)) q_x)) := congrArg sz (Eq.trans (p3) (Eq.trans (congrArg (fun q => p q (p (p q_x (p q_v1 q_v2)) q_v0)) (Eq.trans (p2.symm) (p1))) (congrArg (fun q => p q_x q) (congrArg (fun q => p (p q_x (p q_v1 q_v2)) q) (Eq.trans (p2.symm) (p1))))))
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
          exact (Nat.not_lt_of_ge (Nat.le_of_lt badlt) s2hB.2).elim
        | hit qs2h =>
          have epa : (p q_x (p q_v1 q_v2)) = (p q_v0 (p q_v1 q_v2)) := congrArg (fun q => p q (p q_v1 q_v2)) (Eq.trans (Eq.symm (congrArg (fun q => (L q)) (hb))) (congrArg (fun q => (L (R q))) (hb)))
          have epb : q_v0 = q_v0 := rfl
          apply code_no_pair_left q_v0 (p q_v1 q_v2)
          exact ⟨_, by simpa only [epa, epb] using qs2h⟩
      | hit qs1h =>
        have qs2B := step_bound qs2
        cases qs2 with
...
theorem source_holds (x v0 v1 v2 : CM) :
    x = (eval v0 (eval x (eval v0 (eval v0 (eval (eval x (eval v1 v2)) v0))))) := by
  let H0 := eval v1 v2
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
