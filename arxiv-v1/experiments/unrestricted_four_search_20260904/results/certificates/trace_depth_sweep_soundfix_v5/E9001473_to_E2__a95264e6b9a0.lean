...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 : CM, Step q_x q_v1 q_H0 ∧ Step q_v0 (p (p (p q_x q_x) (p q_x q_x)) q_H0) q_H1 ∧ a = (p q_H1 q_v0) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
 ...
 :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change x = (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) at e0
      have e1 := congrArg (fun q => q) hb
      change x = q_v0 at e1
      have cyc : q_v0 = (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) := (let peq0 : x = (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) := e0; let peq1 : x = q_v0 := e1; let pst0 : (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) = x := Eq.symm (peq0); let pst1 : (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) := Eq.symm (pst1); pst2)
      have hlt : sz q_v0 < sz (p (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0) := Nat.lt_trans (sz_lt_p_left q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) (sz_lt_p_left (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) q_v0)
 ...
 :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change x = (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) at e0
      have e1 := congrArg (fun q => (R q)) ha
      change x = q_v0 at e1
      have e2 := congrArg (fun q => q) hb
      change (p x x) = q_v0 at e2
      have cyc : q_v0 = (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) := (let peq0 : x = (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) := e0; let peq1 : x = q_v0 := e1; let pst0 : (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) = x := Eq.symm (peq0); let pst1 : (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) := Eq.symm (pst1); pst2)
      have hlt : sz q_v0 < sz (p q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))) := sz_lt_p_left q_v0 (p (p (p q_x q_x) (p q_x q_x)) (p q_x q_v1))
      exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
    | hit qs1h =>
      have e0 := congrArg (fun q => (L q)) ha
      change x = q_H1 at e0
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval (eval v0 (eval (eval (eval x x) (eval x x)) (eval x v1))) v0) v0) := by
  let H0 := eval x v1
  have e0a : x = x := by
    change x = x
    rfl
  ...
  let H1 := eval v0 (eval (eval (eval x x) (eval x x)) (eval x v1))
  have e1a : v0 = v0 := by
    change v0 = v0
    rfl
  have e1b : (eval (eval (eval x x) (eval x x)) (eval x v1)) = (p (p (p x x) (p x x)) H0) := by
  ...
  have s1 : Step v0 (p (p (p x x) (p x x)) H0) H1 := by
    rw [← e1a, ← e1b]
    exact eval_step v0 (eval (eval (eval x x) (eval x x)) (eval x v1))
