...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_v2 q_H0 q_H1 q_H2 q_H3 : CM, Step q_v2 q_v1 q_H0 ∧ Step q_v1 q_H0 q_H1 ∧ Step q_v0 q_H1 q_H2 ∧ Step q_x q_v0 q_H3 ∧ a = (p q_H2 (p q_H3 q_x)) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change v = (p q_v0 (p q_v1 (p q_v2 q_v1))) at e0
        ...
        | hit qs3h =>
          ...
          change v = (p q_v0 (p q_v1 (p q_v2 q_v1))) at p0
    ...
    | hit qs1h =>
      ...
      | raw =>
        ...
        | hit qs3h =>
          ...
          change o = q_x at p3
          have z3 := congrArg sz p3
          have badlt : sz q_v1 < sz (p q_v2 q_v1) := by
            have structural : sz q_v1 < sz (p q_v2 q_v1) := sz_lt_p_right q_v2 q_v1
            have large_eq : sz q_v1 = sz q_v1 := congrArg sz (rfl)
            have small_eq : sz (p q_v2 q_v1) = sz (p q_v2 q_v1) := congrArg sz (rfl)
            exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
      ...
      | raw =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            change b = (p q_v1 (p q_v2 q_v1)) at e1
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have epa : (p (p a b) a) = (p (p (p q_H3 (p q_v1 (p q_v2 q_v1))) (p q_v1 (p q_v2 q_v1))) (p q_H3 (p q_v1 (p q_v2 q_v1)))) := Eq.trans (congrArg (fun q => p q a) (Eq.trans (congrArg (fun q => p q b) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))))) (congrArg (fun q => p (p q_H3 (p q_v1 (p q_v2 q_v1))) q) (congrArg (fun q => (R (L q))) (ha))))) (congrArg (fun q => p (p (p q_H3 (p q_v1 (p q_v2 q_v1))) (p q_v1 (p q_v2 q_v1))) q) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho)))))))
            have epb : k = (p q_H3 (p q_v1 (p q_v2 q_v1))) := Eq.trans (Eq.trans (hb) (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha)))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))
            apply code_no_pair_right (p (p q_H3 (p q_v1 (p q_v2 q_v1))) (p q_v1 (p q_v2 q_v1))) (p q_H3 (p q_v1 (p q_v2 q_v1)))
...
theorem source_holds (x v0 v1 v2 : CM) :
    x = (eval (eval (eval v0 (eval v1 (eval v2 v1))) (eval (eval x v0) x)) v0) := by
  let H0 := eval v2 v1
  have e0a : v2 = v2 := by
    change v2 = v2
    rfl
  ...
  let H2 := eval v0 (eval v1 (eval v2 v1))
  have e2a : v0 = v0 := by
    change v0 = v0
    rfl
  have e2b : (eval v1 (eval v2 v1)) = H1 := by
    change H1 = H1
    rfl
  have s2 : Step v0 H1 H2 := by
    rw [← e2a, ← e2b]
    exact eval_step v0 (eval v1 (eval v2 v1))
  let H3 := eval x v0
  have e3a : x = x := by
    change x = x
    rfl
