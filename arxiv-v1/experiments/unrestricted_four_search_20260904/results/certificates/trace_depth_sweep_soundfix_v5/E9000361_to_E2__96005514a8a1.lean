...
inductive Code : CM → CM → CM → Prop
  | law (x v0 v1 H0 H1 : CM)
      (s0 : Step v1 v0 H0)
      (s1 : Step v0 H0 H1) :
      Code (p (p (p H1 v0) v0) x) (p v0 v0) x
inductive Step : CM → CM → CM → Prop
  | raw (a b : CM) : Step a b (p a b)
  | hit {a b o : CM} (h : Code a b o) : Step a b o
end
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_H0 q_H1 : CM, Step q_v1 q_v0 q_H0 ∧ Step q_v0 q_H0 q_H1 ∧ a = (p (p (p q_H1 q_v0) q_v0) q_x) ∧ b = (p q_v0 q_v0) ∧ o = q_x := by
  exact match h with
...
theorem code_no_pair_left (v k : CM) :
  ...
  | raw =>
    ...
    | hit qs1h =>
      ...
      have e2 := congrArg (fun q => q) hb
      change v = (p q_v0 q_v0) at e2
      have cyc : q_v0 = (p q_H1 q_v0) := (let peq0 : v = (p (p q_H1 q_v0) q_v0) := e0; let peq2 : v = (p q_v0 q_v0) := e2; let pst0 : (p (p q_H1 q_v0) q_v0) = v := Eq.symm (peq0); let pst1 : (p (p q_H1 q_v0) q_v0) = (p q_v0 q_v0) := Eq.trans (pst0) (peq2); let pst2 : (p q_H1 q_v0) = q_v0 := congrArg (fun q => L q) (pst1); let pst3 : q_v0 = (p q_H1 q_v0) := Eq.symm (pst2); pst3)
  ...
  | hit qs0h =>
    ...
    | raw =>
      ...
      have e2 := congrArg (fun q => q) hb
      change v = (p q_v0 q_v0) at e2
      have cyc : q_v0 = (p (p q_v0 q_H0) q_v0) := (let peq0 : v = (p (p (p q_v0 q_H0) q_v0) q_v0) := e0; let peq2 : v = (p q_v0 q_v0) := e2; let pst0 : (p (p (p q_v0 q_H0) q_v0) q_v0) = v := Eq.symm (peq0); let pst1 : (p (p (p q_v0 q_H0) q_v0) q_v0) = (p q_v0 q_v0) := Eq.trans (pst0) (peq2); let pst2 : (p (p q_v0 q_H0) q_v0) = q_v0 := congrArg (fun q => L q) (pst1); let pst3 : q_v0 = (p (p q_v0 q_H0) q_v0) := Eq.symm (pst2); pst3)
...
theorem nr1 (x v0 v1 H1 : CM)
  ...
  | raw =>
    ...
    cases qs0 with
    | raw =>
      have he : q_H1 = q_v0 := (let peq0 : v0 = (p q_H1 q_v0) := congrArg (fun q => (L (L q))) (ha); let peq3 : v0 = (p q_v0 q_v0) := hb; let pst0 : (p q_H1 q_v0) = v0 := Eq.symm (peq0); let pst1 : (p q_H1 q_v0) = (p q_v0 q_v0) := Eq.trans (pst0) (peq3); let pst2 : q_H1 = q_v0 := congrArg (fun q => L q) (pst1); pst2)
    ...
    | raw =>
      ...
      | raw =>
        ...
        have badlt : sz v0 < sz H1 := by
          have structural : sz q_v0 < sz (p (p q_v0 (p q_v1 q_v0)) q_v0) := Nat.lt_trans (sz_lt_p_left q_v0 (p q_v1 q_v0)) (sz_lt_p_left (p q_v0 (p q_v1 q_v0)) q_v0)
          have large_eq : sz v0 = sz q_v0 := congrArg sz (p1)
          have small_eq : sz H1 = sz (p (p q_v0 (p q_v1 q_v0)) q_v0) := congrArg sz (p0)
          exact lt_of_lt_of_eq (lt_of_eq_of_lt large_eq structural) small_eq.symm
 ...
 :
  ...
  | raw =>
    ...
    | hit qs1h =>
      ...
      have e1 := congrArg (fun q => q) hb
      change v0 = (p q_v0 q_v0) at e1
      have cyc : q_v0 = (p (p q_H1 q_v0) q_v0) := (let peq0 : v0 = (p (p (p q_H1 q_v0) q_v0) q_x) := e0; let peq1 : v0 = (p q_v0 q_v0) := e1; let pst0 : (p (p (p q_H1 q_v0) q_v0) q_x) = v0 := Eq.symm (peq0); let pst1 : (p (p (p q_H1 q_v0) q_v0) q_x) = (p q_v0 q_v0) := Eq.trans (pst0) (peq1); let pst2 : (p (p q_H1 q_v0) q_v0) = q_v0 := congrArg (fun q => L q) (pst1); let pst3 : q_v0 = (p (p q_H1 q_v0) q_v0) := Eq.symm (pst2); pst3)
  ...
  | hit qs0h =>
    ...
    | raw =>
      ...
      have e1 := congrArg (fun q => q) hb
      change v0 = (p q_v0 q_v0) at e1
      have cyc : q_v0 = (p (p (p q_v0 q_H0) q_v0) q_v0) := (let peq0 : v0 = (p (p (p (p q_v0 q_H0) q_v0) q_v0) q_x) := e0; let peq1 : v0 = (p q_v0 q_v0) := e1; let pst0 : (p (p (p (p q_v0 q_H0) q_v0) q_v0) q_x) = v0 := Eq.symm (peq0); let pst1 : (p (p (p (p q_v0 q_H0) q_v0) q_v0) q_x) = (p q_v0 q_v0) := Eq.trans (pst0) (peq1); let pst2 : (p (p (p q_v0 q_H0) q_v0) q_v0) = q_v0 := congrArg (fun q => L q) (pst1); let pst3 : q_v0 = (p (p (p q_v0 q_H0) q_v0) q_v0) := Eq.symm (pst2); pst3)
...
theorem source_holds (x v0 v1 : CM) :
    x = (eval (eval (eval (eval (eval v0 (eval v1 v0)) v0) v0) x) (eval v0 v0)) := by
  let H0 := eval v1 v0
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
  ...
  change x = (eval (eval (eval (eval H1 v0) v0) x) (eval v0 v0))
  have rawEq : (eval (eval (eval (eval H1 v0) v0) x) (eval v0 v0)) = (eval (p (p (p H1 v0) v0) x) (p v0 v0)) := by
    calc
      (eval (eval (eval (eval H1 v0) v0) x) (eval v0 v0)) = (eval (eval (eval (p H1 v0) v0) x) (eval v0 v0)) := congrArg (fun q => (eval (eval (eval q v0) x) (eval v0 v0))) (eval_raw (nr0 x v0 v1 H1 s1))
      _ = (eval (eval (p (p H1 v0) v0) x) (eval v0 v0)) := congrArg (fun q => (eval (eval q x) (eval v0 v0))) (eval_raw (nr1 x v0 v1 H1 s1))
      _ = (eval (p (p (p H1 v0) v0) x) (eval v0 v0)) := congrArg (fun q => (eval q (eval v0 v0))) (eval_raw (nr2 x v0 v1 H1 s1))
      _ = (eval (p (p (p H1 v0) v0) x) (p v0 v0)) := congrArg (fun q => (eval (p (p (p H1 v0) v0) x) q)) (eval_raw (nr3 x v0 v1))
