...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_v2 q_H0 q_H1 : CM, Step q_v1 q_v2 q_H0 ∧ Step q_v0 (p (p q_x q_x) q_H0) q_H1 ∧ a = (p q_H1 q_v0) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
...
theorem code_bounds {a b o : CM} (h : Code a b o) :
  ...
  ·
    cases s1 with
    | raw =>
      exact Nat.lt_trans (Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_x q_x) (sz_lt_p_left (p q_x q_x) q_H0)) (sz_lt_p_right q_v0 (p (p q_x q_x) q_H0))) (sz_lt_p_left (p q_v0 (p (p q_x q_x) q_H0)) q_v0)
    | hit h1 =>
      exact Nat.lt_trans (Nat.lt_trans (Nat.lt_trans (sz_lt_p_left q_x q_x) (sz_lt_p_left (p q_x q_x) q_H0)) (code_key_small h1)) (sz_lt_p_right q_H1 q_v0)
 ...
 :
  ...
  | raw =>
    ...
    | raw =>
      ...
      change x = (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) at e0
      have e1 := congrArg (fun q => q) hb
      change x = q_v0 at e1
      have cyc : q_v0 = (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) := (let peq0 : x = (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) := e0; let peq1 : x = q_v0 := e1; let pst0 : (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) = x := Eq.symm (peq0); let pst1 : (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) := Eq.symm (pst1); pst2)
      have hlt : sz q_v0 < sz (p (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0) := Nat.lt_trans (sz_lt_p_left q_v0 (p (p q_x q_x) (p q_v1 q_v2))) (sz_lt_p_left (p q_v0 (p (p q_x q_x) (p q_v1 q_v2))) q_v0)
  ...
  | hit qs0h =>
    ...
    | raw =>
      have e0 := congrArg (fun q => q) ha
      change x = (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) at e0
      have e1 := congrArg (fun q => q) hb
      change x = q_v0 at e1
      have cyc : q_v0 = (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) := (let peq0 : x = (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) := e0; let peq1 : x = q_v0 := e1; let pst0 : (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) = x := Eq.symm (peq0); let pst1 : (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) := Eq.symm (pst1); pst2)
      have hlt : sz q_v0 < sz (p (p q_v0 (p (p q_x q_x) q_H0)) q_v0) := Nat.lt_trans (sz_lt_p_left q_v0 (p (p q_x q_x) q_H0)) (sz_lt_p_left (p q_v0 (p (p q_x q_x) q_H0)) q_v0)
      exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
    | hit qs1h =>
      have e0 := congrArg (fun q => q) ha
      change x = (p q_H1 q_v0) at e0
...
theorem nr1 (x v0 v1 v2 H0 : CM)
  ...
  | raw =>
    ...
    cases qs0 with
    | raw =>
      have he : q_H1 = q_v0 := (let peq0 : x = q_H1 := congrArg (fun q => (L q)) (ha); let peq1 : x = q_v0 := congrArg (fun q => (R q)) (ha); let peq2 : (p v1 v2) = q_v0 := hb; let pst0 : q_H1 = x := Eq.symm (peq0); let pst1 : q_H1 = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p v1 v2) := Eq.symm (peq2); let pst3 : q_H1 = (p v1 v2) := Eq.trans (pst1) (pst2); let pst4 : (p v1 v2) = q_v0 := Eq.symm (pst2); let pst5 : q_H1 = q_v0 := Eq.trans (pst3) (pst4); pst5)
      exact step_ne_first (by simpa only [he] using qs1)
    | hit qs0h =>
      have he : q_H1 = q_v0 := (let peq0 : x = q_H1 := congrArg (fun q => (L q)) (ha); let peq1 : x = q_v0 := congrArg (fun q => (R q)) (ha); let peq2 : (p v1 v2) = q_v0 := hb; let pst0 : q_H1 = x := Eq.symm (peq0); let pst1 : q_H1 = q_v0 := Eq.trans (pst0) (peq1); let pst2 : q_v0 = (p v1 v2) := Eq.symm (peq2); let pst3 : q_H1 = (p v1 v2) := Eq.trans (pst1) (pst2); let pst4 : (p v1 v2) = q_v0 := Eq.symm (pst2); let pst5 : q_H1 = q_v0 := Eq.trans (pst3) (pst4); pst5)
      exact step_ne_first (by simpa only [he] using qs1)
  | hit s0h =>
    ...
    cases qs0 with
    | raw =>
      have he : q_H1 = q_v0 := (let peq0 : x = q_H1 := congrArg (fun q => (L q)) (ha); let peq1 : x = q_v0 := congrArg (fun q => (R q)) (ha); let pst0 : q_H1 = x := Eq.symm (peq0); let pst1 : q_H1 = q_v0 := Eq.trans (pst0) (peq1); pst1)
      exact step_ne_first (by simpa only [he] using qs1)
    | hit qs0h =>
      have he : q_H1 = q_v0 := (let peq0 : x = q_H1 := congrArg (fun q => (L q)) (ha); let peq1 : x = q_v0 := congrArg (fun q => (R q)) (ha); let pst0 : q_H1 = x := Eq.symm (peq0); let pst1 : q_H1 = q_v0 := Eq.trans (pst0) (peq1); pst1)
      exact step_ne_first (by simpa only [he] using qs1)
...
theorem source_holds (x v0 v1 v2 : CM) :
    x = (eval (eval (eval v0 (eval (eval x x) (eval v1 v2))) v0) v0) := by
  let H0 := eval v1 v2
  have e0a : v1 = v1 := by
    change v1 = v1
    rfl
  ...
  let H1 := eval v0 (eval (eval x x) (eval v1 v2))
  have e1a : v0 = v0 := by
    change v0 = v0
    rfl
  have e1b : (eval (eval x x) (eval v1 v2)) = (p (p x x) H0) := by
    change (eval (eval x x) H0) = (p (p x x) H0)
    calc
      (eval (eval x x) H0) = (eval (p x x) H0) := congrArg (fun q => (eval q H0)) (eval_raw (nr0 x v0 v1 v2))
      _ = (p (p x x) H0) := (eval_raw (nr1 x v0 v1 v2 H0 s0))
  have s1 : Step v0 (p (p x x) H0) H1 := by
    rw [← e1a, ← e1b]
    exact eval_step v0 (eval (eval x x) (eval v1 v2))
  change x = (eval (eval H1 v0) v0)
  have rawEq : (eval (eval H1 v0) v0) = (eval (p H1 v0) v0) := congrArg (fun q => (eval q v0)) (eval_raw (nr2 x v0 v1 v2 H1 s1))
