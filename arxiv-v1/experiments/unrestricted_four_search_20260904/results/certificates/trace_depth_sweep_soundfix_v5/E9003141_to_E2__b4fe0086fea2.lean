...
theorem code_shape {a b o : CM} (h : Code a b o) :
    ∃ q_x q_v0 q_v1 q_v2 q_H0 q_H1 q_H2 q_H3 : CM, Step q_v2 q_x q_H0 ∧ Step q_v1 q_H0 q_H1 ∧ Step q_v0 (p q_H1 q_v1) q_H2 ∧ Step q_x q_v0 q_H3 ∧ a = (p q_H2 (p q_H3 q_x)) ∧ b = q_v0 ∧ o = q_x := by
  exact match h with
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          ...
          change v = (p q_v0 (p (p q_v1 (p q_v2 q_x)) q_v1)) at e0
        ...
        | hit qs3h =>
          ...
          change v = (p q_v0 (p (p q_v1 (p q_v2 q_x)) q_v1)) at p0
  ...
  | hit qs0h =>
    ...
    | raw =>
      ...
      | raw =>
        ...
        | raw =>
          have e0 := congrArg (fun q => (L q)) ha
          change v = (p q_v0 (p (p q_v1 q_H0) q_v1)) at e0
          have e1 := congrArg (fun q => (R q)) ha
          change k = (p (p q_x q_v0) q_x) at e1
          have e2 := congrArg (fun q => q) hb
          change k = q_v0 at e2
        ...
        | hit qs3h =>
          ...
          have qs3B := qs3B
          have p0 := congrArg (fun q => (L q)) (ha)
          change v = (p q_v0 (p (p q_v1 q_H0) q_v1)) at p0
          have z0 := congrArg sz p0
          have p1 := congrArg (fun q => (R q)) (ha)
          change k = (p q_H3 q_x) at p1
          have z1 := congrArg sz p1
      ...
      | raw =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            change b = (p (p q_v1 (p q_v2 q_x)) q_v1) at e1
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have cyc : q_x = (p (p q_v1 (p q_v2 q_x)) q_v1) := (let peq1 : b = (p (p q_v1 (p q_v2 q_x)) q_v1) := congrArg (fun q => (R (L q))) (ha); let peq4 : b = q_x := ho; let pst0 : (p (p q_v1 (p q_v2 q_x)) q_v1) = b := Eq.symm (peq1); let pst1 : (p (p q_v1 (p q_v2 q_x)) q_v1) = q_x := Eq.trans (pst0) (peq4); let pst2 : q_x = (p (p q_v1 (p q_v2 q_x)) q_v1) := Eq.symm (pst1); pst2)
            have hlt : sz q_x < sz (p (p q_v1 (p q_v2 q_x)) q_v1) := Nat.lt_trans (Nat.lt_trans (sz_lt_p_right q_v2 q_x) (sz_lt_p_right q_v1 (p q_v2 q_x))) (sz_lt_p_left (p q_v1 (p q_v2 q_x)) q_v1)
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
        | hit qs2h =>
          have qs3B := step_bound qs3
          have qs3N := step_no_first qs3
      ...
      | hit qs1h =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have epa : (p (p a b) a) = (p (p (p q_H3 (p q_H1 q_v1)) (p q_H1 q_v1)) (p q_H3 (p q_H1 q_v1))) := Eq.trans (congrArg (fun q => p q a) (Eq.trans (congrArg (fun q => p q b) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))))) (congrArg (fun q => p (p q_H3 (p q_H1 q_v1)) q) (congrArg (fun q => (R (L q))) (ha))))) (congrArg (fun q => p (p (p q_H3 (p q_H1 q_v1)) (p q_H1 q_v1)) q) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho)))))))
            have epb : k = (p q_H3 (p q_H1 q_v1)) := Eq.trans (Eq.trans (hb) (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha)))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))
            apply code_no_pair_right (p (p q_H3 (p q_H1 q_v1)) (p q_H1 q_v1)) (p q_H3 (p q_H1 q_v1))
      ...
      | raw =>
        ...
        | raw =>
          ...
          | raw =>
            ...
            change a = q_v0 at e0
            have e1 := congrArg (fun q => (R (L q))) ha
            change b = (p (p q_v1 q_H0) q_v1) at e1
            have e2 := congrArg (fun q => (R q)) ha
            change a = (p (p q_x q_v0) q_x) at e2
            have e3 := congrArg (fun q => q) hb
            change k = q_v0 at e3
            ...
            exact (Nat.ne_of_lt hlt) (congrArg sz cyc)
          | hit qs3h =>
            have epa : (p (p a b) a) = (p (p (p q_H3 (p (p q_v1 q_H0) q_v1)) (p (p q_v1 q_H0) q_v1)) (p q_H3 (p (p q_v1 q_H0) q_v1))) := Eq.trans (congrArg (fun q => p q a) (Eq.trans (congrArg (fun q => p q b) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))))) (congrArg (fun q => p (p q_H3 (p (p q_v1 q_H0) q_v1)) q) (congrArg (fun q => (R (L q))) (ha))))) (congrArg (fun q => p (p (p q_H3 (p (p q_v1 q_H0) q_v1)) (p (p q_v1 q_H0) q_v1)) q) (Eq.trans (congrArg (fun q => (L (L q))) (ha)) (Eq.trans (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho)))))))
            have epb : k = (p q_H3 (p (p q_v1 q_H0) q_v1)) := Eq.trans (Eq.trans (hb) (Eq.trans (Eq.symm (congrArg (fun q => (L (L q))) (ha))) (congrArg (fun q => (R q)) (ha)))) (congrArg (fun q => p q_H3 q) (Eq.symm (Eq.trans (Eq.symm (congrArg (fun q => (R (L q))) (ha))) (ho))))
            apply code_no_pair_right (p (p q_H3 (p (p q_v1 q_H0) q_v1)) (p (p q_v1 q_H0) q_v1)) (p q_H3 (p (p q_v1 q_H0) q_v1))
            exact ⟨_, by simpa only [epa, epb] using hc⟩
        | hit qs2h =>
          have qs3B := step_bound qs3
          have qs3N := step_no_first qs3
...
theorem nr2 (x v0 v1 v2 H2 H3 : CM)
  ...
  | raw =>
    cases qs2 with
    | raw =>
      have he : v0 = (p (p H3 x) (p q_H1 q_v1)) := (let peq0 : v0 = (p q_v0 (p q_H1 q_v1)) := congrArg (fun q => (L q)) (ha); let peq3 : (p H3 x) = q_v0 := hb; let pst0 : q_v0 = (p H3 x) := Eq.symm (peq3); let pst1 : (p q_v0 (p q_H1 q_v1)) = (p (p H3 x) (p q_H1 q_v1)) := congrArg (fun q => p q (p q_H1 q_v1)) (pst0); let pst2 : v0 = (p (p H3 x) (p q_H1 q_v1)) := Eq.trans (peq0) (pst1); pst2)
      have hs := congrArg sz he
      simp only [getOut, L, R, U, sz] at s3B hs
      omega
    | hit qs2h =>
      have ein : q_v0 = (p H3 x) := (let peq3 : (p H3 x) = q_v0 := hb; let pst0 : q_v0 = (p H3 x) := Eq.symm (peq3); pst0)
      have eout : q_H2 = v0 := (let peq0 : v0 = q_H2 := congrArg (fun q => (L q)) (ha); let pst0 : q_H2 = v0 := Eq.symm (peq0); pst0)
      apply s3O
      refine ⟨(p q_H1 q_v1), ?_⟩
...
theorem source_holds (x v0 v1 v2 : CM) :
    x = (eval (eval (eval v0 (eval (eval v1 (eval v2 x)) v1)) (eval (eval x v0) x)) v0) := by
  let H0 := eval v2 x
  have e0a : v2 = v2 := by
    change v2 = v2
    rfl
  ...
  let H2 := eval v0 (eval (eval v1 (eval v2 x)) v1)
  have e2a : v0 = v0 := by
    change v0 = v0
    rfl
  have e2b : (eval (eval v1 (eval v2 x)) v1) = (p H1 v1) := by
    change (eval H1 v1) = (p H1 v1)
    exact (eval_raw (nr0 x v0 v1 v2 H1 s1))
  have s2 : Step v0 (p H1 v1) H2 := by
    rw [← e2a, ← e2b]
    exact eval_step v0 (eval (eval v1 (eval v2 x)) v1)
  let H3 := eval x v0
  have e3a : x = x := by
    change x = x
    rfl
