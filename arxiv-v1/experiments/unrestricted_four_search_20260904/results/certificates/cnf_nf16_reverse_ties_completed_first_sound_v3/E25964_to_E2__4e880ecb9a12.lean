...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 v2 : CM) : Code (p v0 (p (p v1 v1) v0)) (p v2 v2) v1
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 v2 : CM, a = (p v0 (p (p v1 v1) v0)) ∧ b = (p v2 v2) ∧ o = v1 ∧ sz a = sz (p v0 (p (p v1 v1) v0)) ∧ sz b = sz (p v2 v2) ∧ sz o = sz v1) ∨ False
...
theorem redex0_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p (p v0 (p (p v1 v1) v0)) (p v2 v2)) := by
  intro h
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = (p v0 (p (p v1 v1) v0)) ∧ b = (p v2 v2) ∧ o = v1 ∧ sz a = sz (p v0 (p (p v1 v1) v0)) ∧ sz b = sz (p v2 v2) ∧ sz o = sz v1
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op q1 (op (op q0 q0) q1)) (op q2 q2)) := by
  apply Subtype.ext
