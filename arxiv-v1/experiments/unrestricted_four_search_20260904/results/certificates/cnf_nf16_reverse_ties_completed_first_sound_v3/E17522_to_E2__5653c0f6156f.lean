...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 v2 : CM) : Code (p v0 v1) (p v2 (p v1 (p v1 v1))) v2
  | r1 (v0 v1 v2 : CM) : Code v0 (p v1 (p (p v0 (p v2 (p v2 v2))) (p (p v0 (p v2 (p v2 v2))) (p v0 (p v2 (p v2 v2)))))) v1
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 v2 : CM, a = (p v0 v1) ∧ b = (p v2 (p v1 (p v1 v1))) ∧ o = v2 ∧ sz a = sz (p v0 v1) ∧ sz b = sz (p v2 (p v1 (p v1 v1))) ∧ sz o = sz v2) ∨ (∃ v0 v1 v2 : CM, a = v0 ∧ b = (p v1 (p (p v0 (p v2 (p v2 v2))) (p (p v0 (p v2 (p v2 v2))) (p v0 (p v2 (p v2 v2)))))) ∧ o = v1 ∧ sz a = sz v0 ∧ sz b = sz (p v1 (p (p v0 (p v2 (p v2 v2))) (p (p v0 (p v2 (p v2 v2))) (p v0 (p v2 (p v2 v2)))))) ∧ sz o = sz v1) ∨ False
...
theorem redex0_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p (p v0 v1) (p v2 (p v1 (p v1 v1)))) := by
  intro h
  exact h.2.2 ⟨v2, Code.r0 v0 v1 v2⟩
theorem redex1_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p v0 (p v1 (p (p v0 (p v2 (p v2 v2))) (p (p v0 (p v2 (p v2 v2))) (p v0 (p v2 (p v2 v2))))))) := by
  intro h
  exact h.2.2 ⟨v1, Code.r1 v0 v1 v2⟩
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = (p v0 v1) ∧ b = (p v2 (p v1 (p v1 v1))) ∧ o = v2 ∧ sz a = sz (p v0 v1) ∧ sz b = sz (p v2 (p v1 (p v1 v1))) ∧ sz o = sz v2
@[grind unfold] abbrev C1 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = v0 ∧ b = (p v1 (p (p v0 (p v2 (p v2 v2))) (p (p v0 (p v2 (p v2 v2))) (p v0 (p v2 (p v2 v2)))))) ∧ o = v1 ∧ sz a = sz v0 ∧ sz b = sz (p v1 (p (p v0 (p v2 (p v2 v2))) (p (p v0 (p v2 (p v2 v2))) (p v0 (p v2 (p v2 v2)))))) ∧ sz o = sz v1
...
theorem source_raw (q0 q1 q2 : CM)
  ...
  classical
  generalize H0 : eval q1 q2 = T0
  generalize H1 : eval q2 q2 = T1
  generalize H2 : eval q2 T1 = T2
  generalize H3 : eval q0 T2 = T3
  generalize H4 : eval T0 T3 = T4
  change q0 = T4
  have B0 : EvalCases q1 q2 T0 := by
    rw [← H0]
    exact eval_cases q1 q2
  have B1 : EvalCases q2 q2 T1 := by
    rw [← H1]
    exact eval_cases q2 q2
  have B2 : EvalCases q2 T1 T2 := by
    rw [← H2]
    exact eval_cases q2 T1
  ...
  have N0 : NF T0 := by
    rw [← H0]
    exact eval_nf hq1 hq2
  have N1 : NF T1 := by
    rw [← H1]
    exact eval_nf hq2 hq2
  have N2 : NF T2 := by
    rw [← H2]
    exact eval_nf hq2 N1
  have N3 : NF T3 := by
    rw [← H3]
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op q1 q2) (op q0 (op q2 (op q2 q2)))) := by
  apply Subtype.ext
