...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 v2 : CM) : Code (p v0 v0) (p (p v1 (p v2 v2)) v1) v2
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 v2 : CM, a = (p v0 v0) ∧ b = (p (p v1 (p v2 v2)) v1) ∧ o = v2 ∧ sz a = sz (p v0 v0) ∧ sz b = sz (p (p v1 (p v2 v2)) v1) ∧ sz o = sz v2) ∨ False
...
theorem redex0_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p (p v0 v0) (p (p v1 (p v2 v2)) v1)) := by
  intro h
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = (p v0 v0) ∧ b = (p (p v1 (p v2 v2)) v1) ∧ o = v2 ∧ sz a = sz (p v0 v0) ∧ sz b = sz (p (p v1 (p v2 v2)) v1) ∧ sz o = sz v2
...
theorem source_raw (q0 q1 q2 : CM)
  ...
  have N4 : NF T4 := by
    rw [← H4]
    exact eval_nf N0 N3
  all_goals rcases B1 with ⟨v1_0_0, v1_0_1, v1_0_2, hc1_0⟩ | ⟨hr1, n1⟩
  ...
  all_goals rcases B2 with ⟨v2_0_0, v2_0_1, v2_0_2, hc2_0⟩ | ⟨hr2, n2⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, sz])
  all_goals rcases B3 with ⟨v3_0_0, v3_0_1, v3_0_2, hc3_0⟩ | ⟨hr3, n3⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, sz])
  all_goals rcases B4 with ⟨v4_0_0, v4_0_1, v4_0_2, hc4_0⟩ | ⟨hr4, n4⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, sz])
  all_goals rcases B0 with ⟨v0_0_0, v0_0_1, v0_0_2, hc0_0⟩ | ⟨hr0, n0⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, sz])
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op q1 q1) (op (op q2 (op q0 q0)) q2)) := by
  apply Subtype.ext
