...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 v2 : CM) : Code (p v0 v1) (p v2 (p v1 (p v2 v2))) v1
  | r1 (v0 v1 v2 : CM) : Code v0 (p v1 (p (p v2 (p v0 (p v2 v2))) (p v1 v1))) (p v2 (p v0 (p v2 v2)))
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 v2 : CM, a = (p v0 v1) ∧ b = (p v2 (p v1 (p v2 v2))) ∧ o = v1 ∧ sz a = sz (p v0 v1) ∧ sz b = sz (p v2 (p v1 (p v2 v2))) ∧ sz o = sz v1) ∨ (∃ v0 v1 v2 : CM, a = v0 ∧ b = (p v1 (p (p v2 (p v0 (p v2 v2))) (p v1 v1))) ∧ o = (p v2 (p v0 (p v2 v2))) ∧ sz a = sz v0 ∧ sz b = sz (p v1 (p (p v2 (p v0 (p v2 v2))) (p v1 v1))) ∧ sz o = sz (p v2 (p v0 (p v2 v2)))) ∨ False
...
theorem redex0_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p (p v0 v1) (p v2 (p v1 (p v2 v2)))) := by
  intro h
  exact h.2.2 ⟨v1, Code.r0 v0 v1 v2⟩
theorem redex1_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p v0 (p v1 (p (p v2 (p v0 (p v2 v2))) (p v1 v1)))) := by
  intro h
  exact h.2.2 ⟨(p v2 (p v0 (p v2 v2))), Code.r1 v0 v1 v2⟩
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = (p v0 v1) ∧ b = (p v2 (p v1 (p v2 v2))) ∧ o = v1 ∧ sz a = sz (p v0 v1) ∧ sz b = sz (p v2 (p v1 (p v2 v2))) ∧ sz o = sz v1
@[grind unfold] abbrev C1 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = v0 ∧ b = (p v1 (p (p v2 (p v0 (p v2 v2))) (p v1 v1))) ∧ o = (p v2 (p v0 (p v2 v2))) ∧ sz a = sz v0 ∧ sz b = sz (p v1 (p (p v2 (p v0 (p v2 v2))) (p v1 v1))) ∧ sz o = sz (p v2 (p v0 (p v2 v2)))
...
theorem source_raw (q0 q1 q2 : CM)
  ...
  have B3 : EvalCases q2 T2 T3 := by
    rw [← H3]
    exact eval_cases q2 T2
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op q1 q0) (op q2 (op q0 (op q2 q2)))) := by
  apply Subtype.ext
