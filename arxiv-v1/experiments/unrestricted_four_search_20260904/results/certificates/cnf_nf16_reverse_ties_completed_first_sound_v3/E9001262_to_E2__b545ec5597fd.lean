...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 : CM) : Code (p (p e (p (p v0 v1) v1)) v1) e v1
  | r1 (v0 : CM) : Code v0 v0 e
  | r2 (v0 : CM) : Code (p (p e (p v0 e)) e) e e
  | r3 (v0 : CM) : Code (p (p e (p e v0)) v0) e v0
  | r4 (v0 : CM) : Code (p (p e v0) e) e e
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 : CM, a = (p (p e (p (p v0 v1) v1)) v1) ∧ b = e ∧ o = v1 ∧ sz a = sz (p (p e (p (p v0 v1) v1)) v1) ∧ sz b = sz e ∧ sz o = sz v1) ∨ (∃ v0 : CM, a = v0 ∧ b = v0 ∧ o = e ∧ sz a = sz v0 ∧ sz b = sz v0 ∧ sz o = sz e) ∨ (∃ v0 : CM, a = (p (p e (p v0 e)) e) ∧ b = e ∧ o = e ∧ sz a = sz (p (p e (p v0 e)) e) ∧ sz b = sz e ∧ sz o = sz e) ∨ (∃ v0 : CM, a = (p (p e (p e v0)) v0) ∧ b = e ∧ o = v0 ∧ sz a = sz (p (p e (p e v0)) v0) ∧ sz b = sz e ∧ sz o = sz v0) ∨ (∃ v0 : CM, a = (p (p e v0) e) ∧ b = e ∧ o = e ∧ sz a = sz (p (p e v0) e) ∧ sz b = sz e ∧ sz o = sz e) ∨ False
...
theorem code_nf {a b o : CM} (ha : NF a) (hb : NF b) (h : Code a b o) : NF o := by
  cases h with
  | r0 => exact ha.1.2.1.1.2.1
  | r1 => exact by trivial
  | r2 => exact by trivial
  | r3 => exact ha.1.2.1.2.1
  | r4 => exact by trivial
theorem redex0_not_nf (v0 v1 : CM) :
    ¬ NF (p (p (p e (p (p v0 v1) v1)) v1) e) := by
  intro h
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 : CM) (a b o : CM) : Prop := a = (p (p e (p (p v0 v1) v1)) v1) ∧ b = e ∧ o = v1 ∧ sz a = sz (p (p e (p (p v0 v1) v1)) v1) ∧ sz b = sz e ∧ sz o = sz v1
@[grind unfold] abbrev C1 (v0 : CM) (a b o : CM) : Prop := a = v0 ∧ b = v0 ∧ o = e ∧ sz a = sz v0 ∧ sz b = sz v0 ∧ sz o = sz e
@[grind unfold] abbrev C2 (v0 : CM) (a b o : CM) : Prop := a = (p (p e (p v0 e)) e) ∧ b = e ∧ o = e ∧ sz a = sz (p (p e (p v0 e)) e) ∧ sz b = sz e ∧ sz o = sz e
@[grind unfold] abbrev C3 (v0 : CM) (a b o : CM) : Prop := a = (p (p e (p e v0)) v0) ∧ b = e ∧ o = v0 ∧ sz a = sz (p (p e (p e v0)) v0) ∧ sz b = sz e ∧ sz o = sz v0
@[grind unfold] abbrev C4 (v0 : CM) (a b o : CM) : Prop := a = (p (p e v0) e) ∧ b = e ∧ o = e ∧ sz a = sz (p (p e v0) e) ∧ sz b = sz e ∧ sz o = sz e
...
theorem eval_cases (a b : CM) : EvalCases a b (eval a b) := by
  ...
  · let o := Classical.choose h
    ...
    rcases cc with cc0 | cc1 | cc2 | cc3 | cc4 | impossible
...
theorem source_raw (q0 q1 q2 : CM)
    ...
    q0 = (eval (eval (eval (eval q1 q1) (eval (eval q1 q0) q0)) q0) (eval q2 q2)) := by
  classical
  generalize H0 : eval q1 q1 = T0
  generalize H1 : eval q1 q0 = T1
  generalize H2 : eval T1 q0 = T2
  generalize H3 : eval T0 T2 = T3
  ...
  have B1 : EvalCases q1 q0 T1 := by
    rw [← H1]
    exact eval_cases q1 q0
  have B2 : EvalCases T1 q0 T2 := by
    rw [← H2]
    exact eval_cases T1 q0
  have B3 : EvalCases T0 T2 T3 := by
    rw [← H3]
    exact eval_cases T0 T2
  ...
  have N6 : NF T6 := by
    rw [← H6]
    exact eval_nf N4 N5
  all_goals rcases B5 with ⟨v5_0_0, v5_0_1, hc5_0⟩ | ⟨v5_1_0, hc5_1⟩ | ⟨v5_2_0, hc5_2⟩ | ⟨v5_3_0, hc5_3⟩ | ⟨v5_4_0, hc5_4⟩ | ⟨hr5, n5⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals rcases B0 with ⟨v0_0_0, v0_0_1, hc0_0⟩ | ⟨v0_1_0, hc0_1⟩ | ⟨v0_2_0, hc0_2⟩ | ⟨v0_3_0, hc0_3⟩ | ⟨v0_4_0, hc0_4⟩ | ⟨hr0, n0⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals rcases B3 with ⟨v3_0_0, v3_0_1, hc3_0⟩ | ⟨v3_1_0, hc3_1⟩ | ⟨v3_2_0, hc3_2⟩ | ⟨v3_3_0, hc3_3⟩ | ⟨v3_4_0, hc3_4⟩ | ⟨hr3, n3⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals rcases B4 with ⟨v4_0_0, v4_0_1, hc4_0⟩ | ⟨v4_1_0, hc4_1⟩ | ⟨v4_2_0, hc4_2⟩ | ⟨v4_3_0, hc4_3⟩ | ⟨v4_4_0, hc4_4⟩ | ⟨hr4, n4⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals rcases B6 with ⟨v6_0_0, v6_0_1, hc6_0⟩ | ⟨v6_1_0, hc6_1⟩ | ⟨v6_2_0, hc6_2⟩ | ⟨v6_3_0, hc6_3⟩ | ⟨v6_4_0, hc6_4⟩ | ⟨hr6, n6⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals rcases B2 with ⟨v2_0_0, v2_0_1, hc2_0⟩ | ⟨v2_1_0, hc2_1⟩ | ⟨v2_2_0, hc2_2⟩ | ⟨v2_3_0, hc2_3⟩ | ⟨v2_4_0, hc2_4⟩ | ⟨hr2, n2⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals rcases B1 with ⟨v1_0_0, v1_0_1, hc1_0⟩ | ⟨v1_1_0, hc1_1⟩ | ⟨v1_2_0, hc1_2⟩ | ⟨v1_3_0, hc1_3⟩ | ⟨v1_4_0, hc1_4⟩ | ⟨hr1, n1⟩
  all_goals try (first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz])
  all_goals first | omega | contradiction | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, sz] | grind (config := { splits := 1, gen := 6 }) [Code.r0, Code.r1, Code.r2, Code.r3, Code.r4, sz] | grind (config := { splits := 1, gen := 6 }) [nf_p_left, nf_p_right, nf_p_no, redex0_not_nf, redex1_not_nf, redex2_not_nf, redex3_not_nf, redex4_not_nf, sz]
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op (op (op q1 q1) (op (op q1 q0) q0)) q0) (op q2 q2)) := by
  apply Subtype.ext
