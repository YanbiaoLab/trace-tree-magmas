...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 v2 : CM) : Code (p (p (p v0 v0) v1) v0) (p v1 v2) v1
  | r1 (v0 v1 v2 : CM) : Code (p (p (p v0 v0) (p (p (p v1 v1) v2) v1)) v0) v2 (p (p (p v1 v1) v2) v1)
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 v2 : CM, a = (p (p (p v0 v0) v1) v0) ∧ b = (p v1 v2) ∧ o = v1 ∧ sz a = sz (p (p (p v0 v0) v1) v0) ∧ sz b = sz (p v1 v2) ∧ sz o = sz v1) ∨ (∃ v0 v1 v2 : CM, a = (p (p (p v0 v0) (p (p (p v1 v1) v2) v1)) v0) ∧ b = v2 ∧ o = (p (p (p v1 v1) v2) v1) ∧ sz a = sz (p (p (p v0 v0) (p (p (p v1 v1) v2) v1)) v0) ∧ sz b = sz v2 ∧ sz o = sz (p (p (p v1 v1) v2) v1)) ∨ False
...
theorem redex0_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p (p (p (p v0 v0) v1) v0) (p v1 v2)) := by
  intro h
  exact h.2.2 ⟨v1, Code.r0 v0 v1 v2⟩
theorem redex1_not_nf (v0 v1 v2 : CM) :
    ¬ NF (p (p (p (p v0 v0) (p (p (p v1 v1) v2) v1)) v0) v2) := by
  intro h
  exact h.2.2 ⟨(p (p (p v1 v1) v2) v1), Code.r1 v0 v1 v2⟩
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = (p (p (p v0 v0) v1) v0) ∧ b = (p v1 v2) ∧ o = v1 ∧ sz a = sz (p (p (p v0 v0) v1) v0) ∧ sz b = sz (p v1 v2) ∧ sz o = sz v1
@[grind unfold] abbrev C1 (v0 v1 v2 : CM) (a b o : CM) : Prop := a = (p (p (p v0 v0) (p (p (p v1 v1) v2) v1)) v0) ∧ b = v2 ∧ o = (p (p (p v1 v1) v2) v1) ∧ sz a = sz (p (p (p v0 v0) (p (p (p v1 v1) v2) v1)) v0) ∧ sz b = sz v2 ∧ sz o = sz (p (p (p v1 v1) v2) v1)
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op (op (op q1 q1) q0) q1) (op q0 q2)) := by
  apply Subtype.ext
