...
inductive Code : CM → CM → CM → Prop
  | r0 (v0 v1 : CM) : Code (p (p (p e v0) v1) v1) v0 v1
  | r1 (v0 : CM) : Code v0 v0 e
  | r2 (v0 : CM) : Code (p e (p e v0)) v0 (p e v0)
  | r3 (v0 : CM) : Code (p (p e v0) v0) e v0
  | r4 (v0 : CM) : Code (p (p e v0) v0) (p e v0) v0
def CodeCases (a b o : CM) : Prop := (∃ v0 v1 : CM, a = (p (p (p e v0) v1) v1) ∧ b = v0 ∧ o = v1 ∧ sz a = sz (p (p (p e v0) v1) v1) ∧ sz b = sz v0 ∧ sz o = sz v1) ∨ (∃ v0 : CM, a = v0 ∧ b = v0 ∧ o = e ∧ sz a = sz v0 ∧ sz b = sz v0 ∧ sz o = sz e) ∨ (∃ v0 : CM, a = (p e (p e v0)) ∧ b = v0 ∧ o = (p e v0) ∧ sz a = sz (p e (p e v0)) ∧ sz b = sz v0 ∧ sz o = sz (p e v0)) ∨ (∃ v0 : CM, a = (p (p e v0) v0) ∧ b = e ∧ o = v0 ∧ sz a = sz (p (p e v0) v0) ∧ sz b = sz e ∧ sz o = sz v0) ∨ (∃ v0 : CM, a = (p (p e v0) v0) ∧ b = (p e v0) ∧ o = v0 ∧ sz a = sz (p (p e v0) v0) ∧ sz b = sz (p e v0) ∧ sz o = sz v0) ∨ False
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
@[grind unfold] abbrev C0 (v0 v1 : CM) (a b o : CM) : Prop := a = (p (p (p e v0) v1) v1) ∧ b = v0 ∧ o = v1 ∧ sz a = sz (p (p (p e v0) v1) v1) ∧ sz b = sz v0 ∧ sz o = sz v1
@[grind unfold] abbrev C1 (v0 : CM) (a b o : CM) : Prop := a = v0 ∧ b = v0 ∧ o = e ∧ sz a = sz v0 ∧ sz b = sz v0 ∧ sz o = sz e
@[grind unfold] abbrev C2 (v0 : CM) (a b o : CM) : Prop := a = (p e (p e v0)) ∧ b = v0 ∧ o = (p e v0) ∧ sz a = sz (p e (p e v0)) ∧ sz b = sz v0 ∧ sz o = sz (p e v0)
@[grind unfold] abbrev C3 (v0 : CM) (a b o : CM) : Prop := a = (p (p e v0) v0) ∧ b = e ∧ o = v0 ∧ sz a = sz (p (p e v0) v0) ∧ sz b = sz e ∧ sz o = sz v0
@[grind unfold] abbrev C4 (v0 : CM) (a b o : CM) : Prop := a = (p (p e v0) v0) ∧ b = (p e v0) ∧ o = v0 ∧ sz a = sz (p (p e v0) v0) ∧ sz b = sz (p e v0) ∧ sz o = sz v0
...
theorem source_raw (q0 q1 q2 : CM)
  ...
  have B4 : EvalCases T3 q2 T4 := by
    rw [← H4]
    exact eval_cases T3 q2
  have N0 : NF T0 := by
    rw [← H0]
...
theorem source_holds (q0 q1 q2 : Carrier) :
    q0 = (op (op (op (op (op q1 q1) q2) q0) q0) q2) := by
  apply Subtype.ext
