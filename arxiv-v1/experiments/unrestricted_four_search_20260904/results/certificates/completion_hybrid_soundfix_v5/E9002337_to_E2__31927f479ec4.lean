...
inductive Code : CM → CM → CM → Prop
  | r0 (v00 v01 v02 v03 : CM) : Code (p v00 (p v01 v01)) (p (p v00 (p v02 (p v03 v00))) v00) v01
...
theorem redex0_not_nf (v00 v01 v02 v03 : CM) :
    ¬ NF (p (p v00 (p v01 v01)) (p (p v00 (p v02 (p v03 v00))) v00)) := by
  intro h
...
theorem source_raw (q0 q1 q2 z : CM) (hq0 : NF q0) (hq1 : NF q1) (hq2 : NF q2) (hz : NF z) :
    q0 = (eval (eval q1 (eval q0 q0)) (eval (eval q1 (eval q2 (eval z q1))) q1)) := by
  classical
  have B0 := eval_cases q0 q0
  have B1 := eval_cases q1 (eval q0 q0)
  have B2 := eval_cases z q1
  have B3 := eval_cases q2 (eval z q1)
  have B4 := eval_cases q1 (eval q2 (eval z q1))
  have B5 := eval_cases (eval q1 (eval q2 (eval z q1))) q1
  have B6 := eval_cases (eval q1 (eval q0 q0)) (eval (eval q1 (eval q2 (eval z q1))) q1)
  have Hsrc : Code (p q1 (p q0 q0)) (p (p q1 (p q2 (p z q1))) q1) q0 := .r0 q1 q0 q2 z
  ...
  have N3 : NF (eval q2 (eval z q1)) := eval_nf (hq2) (eval_nf (hz) (hq1))
  have N4 : NF (eval q1 (eval q2 (eval z q1))) := eval_nf (hq1) (eval_nf (hq2) (eval_nf (hz) (hq1)))
  have N5 : NF (eval (eval q1 (eval q2 (eval z q1))) q1) := eval_nf (eval_nf (hq1) (eval_nf (hq2) (eval_nf (hz) (hq1)))) (hq1)
  have N6 : NF (eval (eval q1 (eval q0 q0)) (eval (eval q1 (eval q2 (eval z q1))) q1)) := eval_nf (eval_nf (hq1) (eval_nf (hq0) (hq0))) (eval_nf (eval_nf (hq1) (eval_nf (hq2) (eval_nf (hz) (hq1)))) (hq1))
...
theorem source_holds (q0 q1 q2 z : Carrier) : q0 = (op (op q1 (op q0 q0)) (op (op q1 (op q2 (op z q1))) q1)) := by
  apply Subtype.ext
...
noncomputable def submission : Goal := by
  refine ⟨CM.Carrier, CM.instMagmaNF, (fun q0 q1 q2 q3 => CM.source_holds q0 q1 q2 (op q3 q0)), ?_⟩
  intro target
