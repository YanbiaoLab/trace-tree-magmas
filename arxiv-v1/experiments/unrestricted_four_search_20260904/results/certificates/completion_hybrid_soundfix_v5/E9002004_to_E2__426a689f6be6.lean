...
inductive Code : CM → CM → CM → Prop
  | r0 (v00 v01 v02 v03 : CM) : Code (p (p v00 v00) (p v01 (p (p v01 v01) v02))) (p v00 v03) v01
  | r1 (v10 v11 v12 v13 v14 : CM) : Code (p (p (p (p v10 v10) (p v11 (p (p v11 v11) v12))) (p (p v10 v10) (p v11 (p (p v11 v11) v12)))) (p v13 (p (p v13 v13) v14))) v11 v13
def CodeCases (a b o : CM) : Prop := (∃ v00 v01 v02 v03, a = (p (p v00 v00) (p v01 (p (p v01 v01) v02))) ∧ b = (p v00 v03) ∧ o = v01 ∧ sz a = ((((sz v00 + 1) + (sz v00 + 1)) + 1) + (((sz v01 + 1) + (((((sz v01 + 1) + (sz v01 + 1)) + 1) + (sz v02 + 1)) + 1)) + 1)) ∧ sz b = ((sz v00 + 1) + (sz v03 + 1)) ∧ sz o = sz v01) ∨ (∃ v10 v11 v12 v13 v14, a = (p (p (p (p v10 v10) (p v11 (p (p v11 v11) v12))) (p (p v10 v10) (p v11 (p (p v11 v11) v12)))) (p v13 (p (p v13 v13) v14))) ∧ b = v11 ∧ o = v13 ∧ sz a = ((((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (((sz v11 + 1) + (((((sz v11 + 1) + (sz v11 + 1)) + 1) + (sz v12 + 1)) + 1)) + 1)) + 1) + (((((sz v10 + 1) + (sz v10 + 1)) + 1) + (((sz v11 + 1) + (((((sz v11 + 1) + (sz v11 + 1)) + 1) + (sz v12 + 1)) + 1)) + 1)) + 1)) + 1) + (((sz v13 + 1) + (((((sz v13 + 1) + (sz v13 + 1)) + 1) + (sz v14 + 1)) + 1)) + 1)) ∧ sz b = sz v11 ∧ sz o = sz v13)
...
theorem redex0_not_nf (v00 v01 v02 v03 : CM) :
    ¬ NF (p (p (p v00 v00) (p v01 (p (p v01 v01) v02))) (p v00 v03)) := by
  intro h
  exact h.2.2 ⟨v01, Code.r0 v00 v01 v02 v03⟩

theorem redex1_not_nf (v10 v11 v12 v13 v14 : CM) :
    ¬ NF (p (p (p (p (p v10 v10) (p v11 (p (p v11 v11) v12))) (p (p v10 v10) (p v11 (p (p v11 v11) v12)))) (p v13 (p (p v13 v13) v14))) v11) := by
  intro h
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
def EvalCases (a b o : CM) : Prop := (∃ v00 v01 v02 v03, a = (p (p v00 v00) (p v01 (p (p v01 v01) v02))) ∧ b = (p v00 v03) ∧ o = v01 ∧ sz a = ((((sz v00 + 1) + (sz v00 + 1)) + 1) + (((sz v01 + 1) + (((((sz v01 + 1) + (sz v01 + 1)) + 1) + (sz v02 + 1)) + 1)) + 1)) ∧ sz b = ((sz v00 + 1) + (sz v03 + 1)) ∧ sz o = sz v01) ∨ (∃ v10 v11 v12 v13 v14, a = (p (p (p (p v10 v10) (p v11 (p (p v11 v11) v12))) (p (p v10 v10) (p v11 (p (p v11 v11) v12)))) (p v13 (p (p v13 v13) v14))) ∧ b = v11 ∧ o = v13 ∧ sz a = ((((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (((sz v11 + 1) + (((((sz v11 + 1) + (sz v11 + 1)) + 1) + (sz v12 + 1)) + 1)) + 1)) + 1) + (((((sz v10 + 1) + (sz v10 + 1)) + 1) + (((sz v11 + 1) + (((((sz v11 + 1) + (sz v11 + 1)) + 1) + (sz v12 + 1)) + 1)) + 1)) + 1)) + 1) + (((sz v13 + 1) + (((((sz v13 + 1) + (sz v13 + 1)) + 1) + (sz v14 + 1)) + 1)) + 1)) ∧ sz b = sz v11 ∧ sz o = sz v13) ∨ (o = p a b ∧ sz o = ((sz a + 1) + (sz b + 1)) ∧ ¬ ∃ q, Code a b q)
...
theorem source_raw (q0 q1 z q2 : CM) (hq0 : NF q0) (hq1 : NF q1) (hz : NF z) (hq2 : NF q2) :
    q0 = (eval (eval (eval q1 q1) (eval q0 (eval (eval q0 q0) z))) (eval q1 q2)) := by
  classical
  have B0 := eval_cases q1 q1
  have B1 := eval_cases q0 q0
  have B2 := eval_cases (eval q0 q0) z
  have B3 := eval_cases q0 (eval (eval q0 q0) z)
  have B4 := eval_cases (eval q1 q1) (eval q0 (eval (eval q0 q0) z))
  have B5 := eval_cases q1 q2
  have B6 := eval_cases (eval (eval q1 q1) (eval q0 (eval (eval q0 q0) z))) (eval q1 q2)
  have Hsrc : Code (p (p q1 q1) (p q0 (p (p q0 q0) z))) (p q1 q2) q0 := .r0 q1 q0 z q2
  have N0 : NF (eval q1 q1) := eval_nf (hq1) (hq1)
  have N1 : NF (eval q0 q0) := eval_nf (hq0) (hq0)
  have N2 : NF (eval (eval q0 q0) z) := eval_nf (eval_nf (hq0) (hq0)) (hz)
  have N3 : NF (eval q0 (eval (eval q0 q0) z)) := eval_nf (hq0) (eval_nf (eval_nf (hq0) (hq0)) (hz))
  have N4 : NF (eval (eval q1 q1) (eval q0 (eval (eval q0 q0) z))) := eval_nf (eval_nf (hq1) (hq1)) (eval_nf (hq0) (eval_nf (eval_nf (hq0) (hq0)) (hz)))
  have N5 : NF (eval q1 q2) := eval_nf (hq1) (hq2)
  have N6 : NF (eval (eval (eval q1 q1) (eval q0 (eval (eval q0 q0) z))) (eval q1 q2)) := eval_nf (eval_nf (eval_nf (hq1) (hq1)) (eval_nf (hq0) (eval_nf (eval_nf (hq0) (hq0)) (hz)))) (eval_nf (hq1) (hq2))
...
theorem source_holds (q0 q1 z q2 : Carrier) : q0 = (op (op (op q1 q1) (op q0 (op (op q0 q0) z))) (op q1 q2)) := by
  apply Subtype.ext
