...
theorem source_raw (q0 q3 q2 z q1 : CM) (hq0 : NF q0) (hq3 : NF q3) (hq2 : NF q2) (hz : NF z) (hq1 : NF q1) :
  ...
  have B1 := eval_cases (eval q3 q2) z
  have B2 := eval_cases (eval (eval q3 q2) z) q1
  ...
  have B7 := eval_cases (eval (eval (eval q3 q2) z) q1) (eval q0 (eval q1 (eval q1 (eval q1 q1))))
  have Hsrc : Code (p (p (p q3 q2) z) q1) (p q0 (p q1 (p q1 (p q1 q1)))) q0 := .r0 q3 q2 z q1 q0
  have N0 : NF (eval q3 q2) := eval_nf (hq3) (hq2)
  have N1 : NF (eval (eval q3 q2) z) := eval_nf (eval_nf (hq3) (hq2)) (hz)
  have N2 : NF (eval (eval (eval q3 q2) z) q1) := eval_nf (eval_nf (eval_nf (hq3) (hq2)) (hz)) (hq1)
  ...
  have N7 : NF (eval (eval (eval (eval q3 q2) z) q1) (eval q0 (eval q1 (eval q1 (eval q1 q1))))) := eval_nf (eval_nf (eval_nf (eval_nf (hq3) (hq2)) (hz)) (hq1)) (eval_nf (hq0) (eval_nf (hq1) (eval_nf (hq1) (eval_nf (hq1) (hq1)))))
