...
theorem source_raw (q0 q2 q1 : CM) (hq0 : NF q0) (hq2 : NF q2) (hq1 : NF q1) :
    q0 = (eval q2 (eval q0 (eval q0 (eval q2 (eval q1 q1))))) := by
  classical
  have B0 := eval_cases q1 q1
  have B1 := eval_cases q2 (eval q1 q1)
  have B2 := eval_cases q0 (eval q2 (eval q1 q1))
  have B3 := eval_cases q0 (eval q0 (eval q2 (eval q1 q1)))
  have B4 := eval_cases q2 (eval q0 (eval q0 (eval q2 (eval q1 q1))))
  have Hsrc : Code q2 (p q0 (p q0 (p q2 (p q1 q1)))) q0 := .r0 q2 q0 q1
  have N0 : NF (eval q1 q1) := eval_nf (hq1) (hq1)
  have N1 : NF (eval q2 (eval q1 q1)) := eval_nf (hq2) (eval_nf (hq1) (hq1))
  have N2 : NF (eval q0 (eval q2 (eval q1 q1))) := eval_nf (hq0) (eval_nf (hq2) (eval_nf (hq1) (hq1)))
  have N3 : NF (eval q0 (eval q0 (eval q2 (eval q1 q1)))) := eval_nf (hq0) (eval_nf (hq0) (eval_nf (hq2) (eval_nf (hq1) (hq1))))
  have N4 : NF (eval q2 (eval q0 (eval q0 (eval q2 (eval q1 q1))))) := eval_nf (hq2) (eval_nf (hq0) (eval_nf (hq0) (eval_nf (hq2) (eval_nf (hq1) (hq1)))))
...
theorem source_holds (q0 q2 q1 : Carrier) : q0 = (op q2 (op q0 (op q0 (op q2 (op q1 q1))))) := by
  apply Subtype.ext
  exact source_raw q0.1 q2.1 q1.1 q0.2 q2.2 q1.2
...
noncomputable def submission : Goal := by
  refine ⟨CM.Carrier, CM.instMagmaNF, (fun q0 q1 q2 => (CM.source_holds) q0 q2 q1), ?_⟩
  intro target
