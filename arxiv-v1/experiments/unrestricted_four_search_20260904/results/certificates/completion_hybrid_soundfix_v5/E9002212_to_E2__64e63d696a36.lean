...
inductive Code : CM → CM → CM → Prop
  | r0 (v00 v01 v02 v03 : CM) : Code (p v00 (p (p (p v00 v00) v01) v01)) (p (p v00 (p v02 v03)) v00) v01
  | r1 (v10 v11 v12 : CM) : Code (p (p v10 (p (p (p v10 v10) v11) v11)) (p (p (p (p v10 (p (p (p v10 v10) v11) v11)) (p v10 (p (p (p v10 v10) v11) v11))) v12) v12)) (p v11 (p v10 (p (p (p v10 v10) v11) v11))) v12
  | r2 (v20 v21 v22 : CM) : Code (p v20 (p (p (p v20 v20) v21) v21)) (p (p v20 v22) v20) v21
def CodeCases (a b o : CM) : Prop := (∃ v00 v01 v02 v03, a = (p v00 (p (p (p v00 v00) v01) v01)) ∧ b = (p (p v00 (p v02 v03)) v00) ∧ o = v01 ∧ sz a = ((sz v00 + 1) + (((((((sz v00 + 1) + (sz v00 + 1)) + 1) + (sz v01 + 1)) + 1) + (sz v01 + 1)) + 1)) ∧ sz b = ((((sz v00 + 1) + (((sz v02 + 1) + (sz v03 + 1)) + 1)) + 1) + (sz v00 + 1)) ∧ sz o = sz v01) ∨ (∃ v10 v11 v12, a = (p (p v10 (p (p (p v10 v10) v11) v11)) (p (p (p (p v10 (p (p (p v10 v10) v11) v11)) (p v10 (p (p (p v10 v10) v11) v11))) v12) v12)) ∧ b = (p v11 (p v10 (p (p (p v10 v10) v11) v11))) ∧ o = v12 ∧ sz a = ((((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1) + (((((((((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1) + (((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1)) + 1) + (sz v12 + 1)) + 1) + (sz v12 + 1)) + 1)) ∧ sz b = ((sz v11 + 1) + (((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1)) ∧ sz o = sz v12) ∨ (∃ v20 v21 v22, a = (p v20 (p (p (p v20 v20) v21) v21)) ∧ b = (p (p v20 v22) v20) ∧ o = v21 ∧ sz a = ((sz v20 + 1) + (((((((sz v20 + 1) + (sz v20 + 1)) + 1) + (sz v21 + 1)) + 1) + (sz v21 + 1)) + 1)) ∧ sz b = ((((sz v20 + 1) + (sz v22 + 1)) + 1) + (sz v20 + 1)) ∧ sz o = sz v21)
...
theorem redex0_not_nf (v00 v01 v02 v03 : CM) :
    ¬ NF (p (p v00 (p (p (p v00 v00) v01) v01)) (p (p v00 (p v02 v03)) v00)) := by
  intro h
  exact h.2.2 ⟨v01, Code.r0 v00 v01 v02 v03⟩

theorem redex1_not_nf (v10 v11 v12 : CM) :
    ¬ NF (p (p (p v10 (p (p (p v10 v10) v11) v11)) (p (p (p (p v10 (p (p (p v10 v10) v11) v11)) (p v10 (p (p (p v10 v10) v11) v11))) v12) v12)) (p v11 (p v10 (p (p (p v10 v10) v11) v11)))) := by
  intro h
  exact h.2.2 ⟨v12, Code.r1 v10 v11 v12⟩

theorem redex2_not_nf (v20 v21 v22 : CM) :
    ¬ NF (p (p v20 (p (p (p v20 v20) v21) v21)) (p (p v20 v22) v20)) := by
  intro h
...
theorem eval_nf {a b : CM} (ha : NF a) (hb : NF b) : NF (eval a b) := by
  ...
  · rw [eval_raw h]
    exact ⟨ha, hb, h⟩
def EvalCases (a b o : CM) : Prop := (∃ v00 v01 v02 v03, a = (p v00 (p (p (p v00 v00) v01) v01)) ∧ b = (p (p v00 (p v02 v03)) v00) ∧ o = v01 ∧ sz a = ((sz v00 + 1) + (((((((sz v00 + 1) + (sz v00 + 1)) + 1) + (sz v01 + 1)) + 1) + (sz v01 + 1)) + 1)) ∧ sz b = ((((sz v00 + 1) + (((sz v02 + 1) + (sz v03 + 1)) + 1)) + 1) + (sz v00 + 1)) ∧ sz o = sz v01) ∨ (∃ v10 v11 v12, a = (p (p v10 (p (p (p v10 v10) v11) v11)) (p (p (p (p v10 (p (p (p v10 v10) v11) v11)) (p v10 (p (p (p v10 v10) v11) v11))) v12) v12)) ∧ b = (p v11 (p v10 (p (p (p v10 v10) v11) v11))) ∧ o = v12 ∧ sz a = ((((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1) + (((((((((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1) + (((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1)) + 1) + (sz v12 + 1)) + 1) + (sz v12 + 1)) + 1)) ∧ sz b = ((sz v11 + 1) + (((sz v10 + 1) + (((((((sz v10 + 1) + (sz v10 + 1)) + 1) + (sz v11 + 1)) + 1) + (sz v11 + 1)) + 1)) + 1)) ∧ sz o = sz v12) ∨ (∃ v20 v21 v22, a = (p v20 (p (p (p v20 v20) v21) v21)) ∧ b = (p (p v20 v22) v20) ∧ o = v21 ∧ sz a = ((sz v20 + 1) + (((((((sz v20 + 1) + (sz v20 + 1)) + 1) + (sz v21 + 1)) + 1) + (sz v21 + 1)) + 1)) ∧ sz b = ((((sz v20 + 1) + (sz v22 + 1)) + 1) + (sz v20 + 1)) ∧ sz o = sz v21) ∨ (o = p a b ∧ sz o = ((sz a + 1) + (sz b + 1)) ∧ ¬ ∃ q, Code a b q)
...
theorem source_raw (q0 q1 q2 z : CM) (hq0 : NF q0) (hq1 : NF q1) (hq2 : NF q2) (hz : NF z) :
    q0 = (eval (eval q1 (eval (eval (eval q1 q1) q0) q0)) (eval (eval q1 (eval q2 z)) q1)) := by
  classical
  have B0 := eval_cases q1 q1
  have B1 := eval_cases (eval q1 q1) q0
  have B2 := eval_cases (eval (eval q1 q1) q0) q0
  have B3 := eval_cases q1 (eval (eval (eval q1 q1) q0) q0)
  have B4 := eval_cases q2 z
  have B5 := eval_cases q1 (eval q2 z)
  have B6 := eval_cases (eval q1 (eval q2 z)) q1
  have B7 := eval_cases (eval q1 (eval (eval (eval q1 q1) q0) q0)) (eval (eval q1 (eval q2 z)) q1)
  have Hsrc : Code (p q1 (p (p (p q1 q1) q0) q0)) (p (p q1 (p q2 z)) q1) q0 := .r0 q1 q0 q2 z
  have N0 : NF (eval q1 q1) := eval_nf (hq1) (hq1)
  have N1 : NF (eval (eval q1 q1) q0) := eval_nf (eval_nf (hq1) (hq1)) (hq0)
  have N2 : NF (eval (eval (eval q1 q1) q0) q0) := eval_nf (eval_nf (eval_nf (hq1) (hq1)) (hq0)) (hq0)
  have N3 : NF (eval q1 (eval (eval (eval q1 q1) q0) q0)) := eval_nf (hq1) (eval_nf (eval_nf (eval_nf (hq1) (hq1)) (hq0)) (hq0))
  have N4 : NF (eval q2 z) := eval_nf (hq2) (hz)
  have N5 : NF (eval q1 (eval q2 z)) := eval_nf (hq1) (eval_nf (hq2) (hz))
  have N6 : NF (eval (eval q1 (eval q2 z)) q1) := eval_nf (eval_nf (hq1) (eval_nf (hq2) (hz))) (hq1)
  have N7 : NF (eval (eval q1 (eval (eval (eval q1 q1) q0) q0)) (eval (eval q1 (eval q2 z)) q1)) := eval_nf (eval_nf (hq1) (eval_nf (eval_nf (eval_nf (hq1) (hq1)) (hq0)) (hq0))) (eval_nf (eval_nf (hq1) (eval_nf (hq2) (hz))) (hq1))
...
theorem source_holds (q0 q1 q2 z : Carrier) : q0 = (op (op q1 (op (op (op q1 q1) q0) q0)) (op (op q1 (op q2 z)) q1)) := by
  apply Subtype.ext
