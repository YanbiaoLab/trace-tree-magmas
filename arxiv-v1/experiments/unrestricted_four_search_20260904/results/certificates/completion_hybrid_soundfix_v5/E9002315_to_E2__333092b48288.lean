...
theorem source_raw (q0 q1 q2 q3 z : CM) (hq0 : NF q0) (hq1 : NF q1) (hq2 : NF q2) (hq3 : NF q3) (hz : NF z) :
    q0 = (eval (eval q1 (eval (eval q2 q3) (eval q1 (eval z q1)))) (eval (eval q0 q0) q1)) := by
  classical
  generalize hE0 : (eval q2 q3) = E0
  ...
  have B0 : EvalCases q2 q3 E0 := by rw [← hE0]; exact eval_cases q2 q3
  ...
  have Hsrc : Code (p q1 (p (p q2 q3) (p q1 (p z q1)))) (p (p q0 q0) q1) q0 := .r0 q1 q2 q3 z q0
  have N0 : NF E0 := by rw [← hE0]; exact eval_nf (hq2) (hq3)
...
theorem source_holds (q0 q1 q2 q3 z : Carrier) : q0 = (op (op q1 (op (op q2 q3) (op q1 (op z q1)))) (op (op q0 q0) q1)) := by
  apply Subtype.ext
...
noncomputable def submission : Goal := by
  refine ⟨CM.Carrier, CM.instMagmaNF, (fun q0 q1 q2 q3 => ((fun q0 q1 q2 q3 => CM.source_holds q0 q1 q2 q3 q2)) q0 q1 q2 q3), ?_⟩
  intro target
