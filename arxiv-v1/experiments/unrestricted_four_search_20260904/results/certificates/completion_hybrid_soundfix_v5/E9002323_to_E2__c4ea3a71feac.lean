...
theorem source_raw (q0 q1 q2 q3 z : CM) (hq0 : NF q0) (hq1 : NF q1) (hq2 : NF q2) (hq3 : NF q3) (hz : NF z) :
    q0 = (eval (eval q1 (eval q0 q0)) (eval (eval (eval q1 q2) (eval q1 (eval q3 z))) q1)) := by
  classical
  generalize hE0 : (eval q0 q0) = E0
  generalize hE1 : (eval q1 E0) = E1
  generalize hE2 : (eval q1 q2) = E2
  generalize hE3 : (eval q3 z) = E3
  ...
  have B3 : EvalCases q3 z E3 := by rw [← hE3]; exact eval_cases q3 z
  ...
  have Hsrc : Code (p q1 (p q0 q0)) (p (p (p q1 q2) (p q1 (p q3 z))) q1) q0 := .r0 q1 q0 q2 q3 z
  ...
  have N3 : NF E3 := by rw [← hE3]; exact eval_nf (hq3) (hz)
...
theorem source_holds (q0 q1 q2 q3 z : Carrier) : q0 = (op (op q1 (op q0 q0)) (op (op (op q1 q2) (op q1 (op q3 z))) q1)) := by
  apply Subtype.ext
...
noncomputable def submission : Goal := by
  refine ⟨CM.Carrier, CM.instMagmaNF, (fun q0 q1 q2 q3 => CM.source_holds q0 q1 q2 q3 q2), ?_⟩
  intro target
