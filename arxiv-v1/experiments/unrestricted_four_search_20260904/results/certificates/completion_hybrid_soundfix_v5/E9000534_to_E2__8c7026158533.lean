...
inductive Code : CM → CM → CM → Prop
  | r0 (v00 v01 v02 v03 v04 : CM) : Code (p (p v00 (p v01 v02)) v03) (p v04 (p v03 (p v03 (p v03 v03)))) v04
...
theorem redex0_not_nf (v00 v01 v02 v03 v04 : CM) :
    ¬ NF (p (p (p v00 (p v01 v02)) v03) (p v04 (p v03 (p v03 (p v03 v03))))) := by
  intro h
...
theorem source_raw (q0 q3 q2 z q1 : CM) (hq0 : NF q0) (hq3 : NF q3) (hq2 : NF q2) (hz : NF z) (hq1 : NF q1) :
    q0 = (eval (eval (eval q3 (eval q2 z)) q1) (eval q0 (eval q1 (eval q1 (eval q1 q1))))) := by
  classical
  have B0 := eval_cases q2 z
  have B1 := eval_cases q3 (eval q2 z)
  have B2 := eval_cases (eval q3 (eval q2 z)) q1
  ...
  have B7 := eval_cases (eval (eval q3 (eval q2 z)) q1) (eval q0 (eval q1 (eval q1 (eval q1 q1))))
  have Hsrc : Code (p (p q3 (p q2 z)) q1) (p q0 (p q1 (p q1 (p q1 q1)))) q0 := .r0 q3 q2 z q1 q0
  have N0 : NF (eval q2 z) := eval_nf (hq2) (hz)
  have N1 : NF (eval q3 (eval q2 z)) := eval_nf (hq3) (eval_nf (hq2) (hz))
  have N2 : NF (eval (eval q3 (eval q2 z)) q1) := eval_nf (eval_nf (hq3) (eval_nf (hq2) (hz))) (hq1)
  ...
  have N7 : NF (eval (eval (eval q3 (eval q2 z)) q1) (eval q0 (eval q1 (eval q1 (eval q1 q1))))) := eval_nf (eval_nf (eval_nf (hq3) (eval_nf (hq2) (hz))) (hq1)) (eval_nf (hq0) (eval_nf (hq1) (eval_nf (hq1) (eval_nf (hq1) (hq1)))))
...
theorem source_holds (q0 q3 q2 z q1 : Carrier) : q0 = (op (op (op q3 (op q2 z)) q1) (op q0 (op q1 (op q1 (op q1 q1))))) := by
  apply Subtype.ext
