...
inductive EvalCases : CM → CM → CM → Prop
  | r0 (v00 v01 v02 v03 v04 : CM) : EvalCases (p (p v00 (p v01 v02)) v03) (p v04 (p v03 (p v03 (p v03 v03)))) v04
...
theorem no_code_r0 {v00 v01 v02 v03 v04 : CM} (n : ¬ ∃ q, Code (p (p v00 (p v01 v02)) v03) (p v04 (p v03 (p v03 (p v03 v03)))) q) : False := n ⟨_, Code.r0 v00 v01 v02 v03 v04⟩
...
theorem nf_code_r0 {v00 v01 v02 v03 v04 : CM} (h : NF (p (p (p v00 (p v01 v02)) v03) (p v04 (p v03 (p v03 (p v03 v03)))))) : False := redex0_not_nf v00 v01 v02 v03 v04 h
...
theorem source_raw (q0 q3 q2 z q1 : CM) (hq0 : NF q0) (hq3 : NF q3) (hq2 : NF q2) (hz : NF z) (hq1 : NF q1) :
  ...
  classical
  generalize hE0 : (eval q2 z) = E0
  generalize hE1 : (eval q3 E0) = E1
  ...
  have B0 : EvalCases q2 z E0 := by rw [← hE0]; exact eval_cases q2 z
  have B1 : EvalCases q3 E0 E1 := by rw [← hE1]; exact eval_cases q3 E0
  ...
  have N0 : NF E0 := by rw [← hE0]; exact eval_nf (hq2) (hz)
  have N1 : NF E1 := by rw [← hE1]; exact eval_nf (hq3) (N0)
