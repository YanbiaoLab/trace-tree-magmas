...
inductive EvalCases : CM → CM → CM → Prop
  | r0 (v00 v01 v02 v03 : CM) : EvalCases (p (p (p v00 v01) v02) v01) (p v03 (p v01 (p v01 (p v01 v01)))) v03
...
theorem no_code_r0 {v00 v01 v02 v03 : CM} (n : ¬ ∃ q, Code (p (p (p v00 v01) v02) v01) (p v03 (p v01 (p v01 (p v01 v01)))) q) : False := n ⟨_, Code.r0 v00 v01 v02 v03⟩
...
theorem nf_code_r0 {v00 v01 v02 v03 : CM} (h : NF (p (p (p (p v00 v01) v02) v01) (p v03 (p v01 (p v01 (p v01 v01)))))) : False := redex0_not_nf v00 v01 v02 v03 h
...
theorem source_raw (q0 q2 q1 z : CM) (hq0 : NF q0) (hq2 : NF q2) (hq1 : NF q1) (hz : NF z) :
  ...
  have B0 : EvalCases q2 q1 E0 := by rw [← hE0]; exact eval_cases q2 q1
  ...
  have N0 : NF E0 := by rw [← hE0]; exact eval_nf (hq2) (hq1)
